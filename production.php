...
<body class="v35 webkit <?=$database->bodyClass($_SERVER['HTTP_USER_AGENT']); ?> ar-AE production <?php if($dorf1==''){echo 'perspectiveBuildings';}else{ echo 'perspectiveResources';} ?> <?php echo DIRECTION; ?> buildingsV3">
        ...
        <div id="center">
            ...
            <div id="contentOuterContainer" class="size1">
                ...
                <div id="content" class="production">
                    ...
                    <div title="" class="container <?php echo $_GET['t'] == 1 ? 'active' : 'normal'; ?>">
                        ...
                        <div class="content">
                            ...
                            <a id="buttonzzz1" href="dorf3.php?s=3" class="tabItem"><?php echo $lang['dorf']['D1']; ?></a>
                        </div>
                    </div>

                    <script type="text/javascript">
                        if (jQuery('#buttonzzz1')) {
                            jQuery('#buttonzzz1').click(function (event) {
                    ...
                    <div title="" class="container <?php echo $_GET['t'] == 2 ? 'active' : 'normal'; ?>">
                        ...
                        <div class="content">
                            ...
                            <a id="buttonQQQ2" href="dorf3.php?s=3" class="tabItem"><?php echo $lang['dorf']['D2']; ?></a>
                        </div>
                    </div>

                    <script type="text/javascript">
                        if (jQuery('#buttonQQQ2')) {
                            jQuery('#buttonQQQ2').click(function (event) {
                                jQuery(window).trigger('tabClicked', [this, {
                                    "class": "normal",
                                    "title": false,
                                    "target": false,
                    ...
                    <div title="" class="container <?php echo $_GET['t'] == 3 ? 'active' : 'normal'; ?>">
                        ...
                        <div class="content">
                            ...
                            <a id="buttonvV3" href="dorf3.php?s=3" class="tabItem"><?php echo $lang['dorf']['D3']; ?></a>
                        </div>
                    </div>

                    <script type="text/javascript">
                        if (jQuery('#buttonvV3')) {
                            jQuery('#buttonvV3').click(function (event) {
                                jQuery(window).trigger('tabClicked', [this, {
                                    "class": "normal",
                                    "title": false,
                                    "target": false,
                    ...
                    <div title="" class="container <?php echo $_GET['t'] == 4 ? 'active' : 'normal'; ?>">
                        ...
                        <div class="content">
                            ...
                            <a id="buttonAaA4" href="dorf3.php?s=3" class="tabItem"><?php echo $lang['dorf']['D4']; ?></a>
                        </div>
                    </div>

                    <script type="text/javascript">
                        if (jQuery('#buttonAaA4')) {
                            jQuery('#buttonAaA4').click(function (event) {
                                jQuery(window).trigger('tabClicked', [this, {
                                    "class": "normal",
                                    "title": false,
                                    "target": false,
                    ...
                    <div title="" class="container <?php echo $_GET['t'] == 5 ? 'active' : 'normal'; ?>">
                        ...
                        <div class="content">
                            ...
                            <a id="buttonWwW5" href="dorf3.php?s=3" class="tabItem"><?php echo $lang['dorf']['D5']; ?></a>
                        </div>
                    </div>

                    <script type="text/javascript">
                        if (jQuery('#buttonWwW5')) {
                            jQuery('#buttonWwW5').click(function (event) {
                                jQuery(window).trigger('tabClicked', [this, {
                                    "class": "normal",
                                    "title": false,
                                    "target": false,
                ...
                <div class="total productionContainer">
                            ...
                            <div class="fluidSpeechBubble">
                                ...
                                <div class="fluidSpeechBubble-contents cf">
                                    <form id="fluidSpeechBubble" method="post" action="">
                                        ...
                                        <div>
                                            <button type="button" class="textButtonV1 gold    productionBoostButton wood" coins="50" id="buttonnNn6" onclick=""><div class="button-container addHoverClick">
                    ...
                    <script type="text/javascript" id="buttonnNn6_script">
                    jQuery(function()
                        {
                        jQuery('#buttonnNn6').click(function (event)
                        {
                            jQuery(window).trigger('buttonClicked', [this, {"type":"button","value":"\u0641\u0639\u0644","confirm":"","onclick":"","wayOfPayment":{"featureKey":"productionboostWood","context":"production"},"title":"\u062a\u0641\u0639\u064a\u0644 \u0627\u0644\u0622\u0646 &lt;br&gt; \u0645\u062f\u0629 \u0627\u0644\u0632\u064a\u0627\u062f\u0629 \u0623\u064a\u0627\u0645 &lt;span class=&quot;bold&quot;&gt;4&lt;\/span&gt; \u0627\u064a\u0627\u0645","coins":50,"id":"buttonnNn6"}]);
                        });
                        });
                    </script>                        </div>
