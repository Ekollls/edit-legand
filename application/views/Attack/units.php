...
<div id="build" class="gid16 level3">
	    	<div class="a2b">
	...
	<tr>
        ...
        if ($Unit[11]>0){
        echo "<img class=\"unit uhero\" src=\"".GP_LOCATION2."x.gif\" title=\"".U0."\" alt=\"Hero\"> <input class=\"text\" name=\"t11\" value=\"".($rArray[15] ? 1 : '')."\" maxlength=\"6\" type=\"text\">   ";
...
<script>
    jQuery(function () {
        Travian.Game.RallyPoint.initialize(jQuery('#troops'));
    });
</script>
