...
if($village->unitarray['u11']>0){
    ...
    <div class="redeployHero">
        <label><input type="checkbox" value="1" name="redeployHero" class="redeployHeroSetting check">تغییر خانه قهرمان</label> </div>
<?php
	//}
}
?>
<div class="clear"></div>
<button type="submit" value="ok" name="s1" id="btn_ok" class="textButtonV1 green  ">
