...
<form method="post" action="build.php?t=2&id=39">
            ...
            <table class="troop_details" cellpadding="1" cellspacing="1">
                ...
                <tbody class="units">
                 ...
                 <?php
                for($i=$start;$i<=($end);$i++) {
                      echo "<td><img src=\"".GP_LOCATION2."x.gif\" class=\"unit u".$i."\" title=\"\" alt=\"\" /></td>";
                  } if ($process['t11'] != ''){
...
<input name="csrf" value="<?php echo $session->checker;?>" type="hidden">
...
<?php
           ...
           if ($process['c']!=2){
           if($protect>time() && $process[2] != 2 && $session->protect==1){ // // NoBody - Fixed
