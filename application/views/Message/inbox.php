...
<table cellpadding="1" cellspacing="1" id="overview" class="index">
		<thead>
			<tr>
...
<th class="sent"><?=MSG2?></th>
    ...
    echo "<img src=\"".GP_LOCATION2."x.gif\" class=\"messageStatus messageStatus".($message->inbox1[$i-1]['viewed'] == 0 ? 'Unread' : 'Read')."\" alt=\"\">";
