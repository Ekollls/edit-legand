...
/*
    CopyRight Info:
        All Of the Copy Rights Of The Script Is Reserved For Benyamin Ebrahimi
        You may have made some changes but You Have No Right To remove This Copy Right!
        Edited AND Developed By SHADOW!
        For Debug And Support
            Contact: Arctic_x2@yahoo.com
                Mob: 0935-118-5399
*/
if($session->uid < 5){
...
$name = 1;
if($query == 0) {        
    $outputList .= "<td colspan=\"4\" class=\"none\">هیچ پیامی برای نمایش وجود ندارد .</td>";
}else{
...
if ($reason == 'تبلیغات'){$color = "background-color:#FF0066";}
else if($reason == 'آزار و اذیت'){$color = "background-color:#71D000";}
else if($reason == 'فروش طلا'){$color = "background-color:orange";}
else if($reason == 'غیره'){$color = "background-color:blue";}
	...
	$outputList .= "<img src=\"".GP_LOCATION2."x.gif\" class=\"messageStatus messageStatus".$viewed."\" alt=\"خوانده شده\">
...
<table cellpadding="1" cellspacing="1" id="overview" class="inbox">
		<thead>
			<tr>
				...
				<th style="background-color:#edeceb;" class="dat"><b>ارسال شده&nbsp;</b><img src="img/x.gif" alt="sort" /></a></th>
			</tr>
		</thead>
...
<div class="paper" >
	<div class="layout">
		...
		<div id="time">
			...
			<div class="header text"><?php $date = $generator->procMtime($time);echo $date[0]; ?> <?php echo $date[1]; ?></div>
			<div class="clear"></div>
		</div>
...
<?php } }else{header("Location: nachrichten.php");}?>