...
<div class="boxes buildingList" style="top: 30px; right: 27px;">
    ...
    <div class="boxes-contents cf">
        ...
        <div class="finishNow"><button type="button" class="gold  textButtonV1 gold       " id="buttonTdNYVlGP9Z7EJ"><div class="button-container addHoverClick">
    ...
    window.addEvent('domready', function()
        ...
        foreach($building->buildArray as $jobs) {
            ...
            if($mas[$jobs['type']]==$jj){
                ...
                echo "<img src=\"".GP_LOCATION2."x.gif\" class=\"del\" title=\"".BUILDING_CANCEL."\" alt=\"".BUILDING_CANCEL."\" /></a><div class=\"name\">";}else{
                echo "<a style='cursor:default'><img src=\"".GP_LOCATION2."x.gif\" class=\"del inactive\"/></a><div class=\"name\">";
            }
            ...
            if($jobs['master'] == 0){
                ...
                echo "<span class=\"none\">".$building->procResType($jobs['type'])."</span> <span class=\"lvl\">".$jobs['level']."</span> <small><span class=\"none\">".BUILDING_ARCHITECT." <font color=\"#B3B3B3\">(هزینه:  1 سکه)</font></span></small></div><div class=\"clear\"></div></li>";
            }
                $jj++;
                echo '</ul>';
            }
