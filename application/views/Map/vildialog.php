    ...
    <div class="detailImage">
        <div id="options">
            ...
            <?php if($session->goldclub){ ?>
                ...
                <?php } }else{ ?>
                    <span class="a arrow disabled" title="Create a list of farms first From a collection point">افزودن به فارم لیست</span></span>
...
<div id="oasis1InstantTabs" class="instantTabs">
    ...
    <table cellpadding="0" cellspacing="0" id="troop_info" class="rep transparent">
        ...
        <?php if($query != 0){
            ...
            ?>
<tbody><tr><td>اطلاعاتی در دسترس نیست!</td></tr></tbody>
            <?php
        } ?>
    </tbody>
