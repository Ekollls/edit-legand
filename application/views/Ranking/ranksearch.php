                ...
                <table class="transparent">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="submit" value="search" name="search" id="btn_ok" class="textButtonV1 green" version="textButtonV1">
							<script type="text/javascript" id="submit_script">
	jQuery(function() {
        jQuery('button#submit').click(function () {
            jQuery(window).trigger('buttonClicked', [this, {"type":"submit","value":"\u062a\u0645\u0627\u0645","name":"submit","id":"submit","class":"textButtonV1 green ","title":"","confirm":"","onclick":"","version":"textButtonV1"}]);
        });
	});
</script>
