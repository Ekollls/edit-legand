...
<table cellpadding="1" cellspacing="1" id="player" class="row_table_data borderGap">
	<thead>
		...
		<td class="ra ">N
			...
			<td class="pla ">
                                    <?php echo OVERVIEW1; ?>                         </td>
			<td class="pop  "> <?php echo OVERVIEW8; ?>  
                                                                </td>
			<td class="vil">
                                  <?php echo OVERVIEW7; ?>                          </td>
        ...
        if(count($ranking->getRank()) > 0) {
            ...
            for($i=$start;$i<($start+20);$i++) {
            	if(isset($ranking[$i]['username']) && $ranking[$i] != "pad") {
                    ...
                    echo $i.".</td><td><i class=\"tribe".$ranking[$i]['tribe']."_medium\" title=". constant('TRIBE'.$ranking[$i]['tribe'])."></i></td><td class=\"pla \" >";
