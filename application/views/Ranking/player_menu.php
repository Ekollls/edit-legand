    ...
    <div class="subTabs_tabs">
        ...
        <div id="tab1" class="container <?php if(!isset($_GET) || $_GET['id']==1) {echo "active favourite";} else {echo "normal";} ?>">
            ...
            <div class="content favor favorKeyoverview ">
                <a id="button6623e7bc53dd0" href="statistiken.php?id=1" class="tabItem normal" data-tab-id="4" data-active-tab="1">
                    <?=PROFM1?>
                </a>
            </div>
        ...
        <div id="tab2" class="container <?php if($_GET['id']==31) {echo "active favourite";} else {echo "normal";} ?>">
  
            <div class="content favor favorKeyattackers ">
                <a id="button6623e7bc53dd2" href="statistiken.php?id=31" class="tabItem normal" data-tab-id="41" data-active-tab="4">
                    <?=OTPRAV3?>
                </a>
            </div>
            <svg class="star" viewBox="0 0 24 24" fill="white">
        ...
        <div id="tab3" class="container <?php if($_GET['id']==32) {echo "active favourite";} else {echo "normal";} ?>">
   
            <div class="content favor favorKeydefenders">
                <a id="button6623e7bc53dd3" href="statistiken.php?id=32" class="tabItem normal" data-tab-id="42" data-active-tab="8">
                    <?=STATISTIC37?>
                </a>
            </div>
            <svg class="star" viewBox="0 0 24 24" fill="white">
        ...
        <div id="tab4" class="container <?php if($_GET['id']==33) {echo "active favourite";} else {echo "normal";} ?>">
  
            <div class="content favor favorKeytop10">
                <a id="button6623e7bc53dd4" href="statistiken.php?id=7" class="tabItem normal" data-tab-id="43" data-active-tab="0">
                   10 نفر <?=STATISTIC9?> 
                </a>
            </div>
            <svg class="star" viewBox="0 0 24 24" fill="white">
