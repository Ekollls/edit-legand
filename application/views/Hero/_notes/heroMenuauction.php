...
<div class="content favor favorKeyplayer active <?= ($_GET['id'] == 1 || $_GET['id'] == 31 || $_GET['id'] == 32 || $_GET['id'] == 7) ? 'favorActive active' : 'tabItem normal ' ?>">
          ...
          <a id="buttonW1" title="" class="tabItem active " href="hero_inventory.php"><?=STATISTIC28?></a>
                </div>
                    ...
                    <a id="buttonF2" title="" class="tabItem normal " href="heroskill.php">
                     <?=STATISTIC29?>                </a>
                </div>
                                                                    <div class="content favor favorKeyvillage ">
                    <a id="buttonF3" title="" class="tabItem  normal" href="hero_adventure.php">
                       <?=STATISTIC30?>               </a>
                </div>
				
                                                                    <div class="content favor favorKeyhero ">
                    <a id="buttonM4" title="" class="tabItem  normal" href="hero_auction.php">
                 <?=STATISTIC31?>               </a>
                </div>
                                                                    <div class="content favor favorKeygeneral ">
                    <a id="buttonm5" title="" class="tabItem  normal" href="#">
               <?=STATISTIC27?>                </a>
                </div>
                                                                    <div class="content favor favorKeybonus">
                    <a id="buttonv6" title="" class="tabItem  normal" href="#">
                     تست شسیس                 </a>
                </div>
                                                                    <div class="content favor favorKeyfarms">
                    <a id="buttonf7" title="" class="tabItem  normal" href="#">
                     تستشسیشسی                  </a>
                </div>
                                                                    <div class="content favor favorKeywonderoftheworld">
                    <a id="buttonl8" title="" class="tabItem  normal" href="#">
                      تست  یسبیس                  </a>
                </div>
                                            </div>
