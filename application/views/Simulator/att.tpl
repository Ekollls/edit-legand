                                ...
                                <?php
                                    for ($i = $start; $i <= $end; $i++) {
                                        echo '<tr>'
                                            ...
                                            . '<td class="value"><input class="text" type="text" name="au_' . $i . '" value="' . $form->getValue('au_' . $i) . '" maxlength="60"></td>'
                                    ...
                                    <?php
                                        for ($i = $start; $i <= $end; $i++) {
                                            echo '<tr>'
                                                . '<td class="ico"><img src="img/x.gif" class="unit u' . $i . '" alt="' . constant('U' . $i) . '" title="' . constant('U' . $i) . '"></td>'
                                                . '<td class="desc">' . $technology->unarray[$i] . '</td>'
                                                . '<td class="value"><input class="text" type="text" name="pu_' . $i . '" value="' . $form->getValue('pu_' . $i) . '" maxlength="60"></td>'
