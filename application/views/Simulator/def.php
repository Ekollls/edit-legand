                            ...
                            <?php
                                for ($i = $start; $i <= $end; $i++) {
                                    echo '<tr>'
                                        ...
                                        . '<td class="value"><input class="text" type="text" name="du_' . $i . '" value="' . getValue('du_' . $i) . '" maxlength="60"></td>'
                                        . '<td class="research"><input class="text" type="text" name="da_' . ($i - $start + 1) . '" value="' . getValue('da_' . ($i - $start + 1)) . '" maxlength="2"></td>'
                                        . '</tr>';
                                }
                            ?>
                            </tbody>
                        ...
                        <table cellpadding="1" cellspacing="1">
                            ...
                            <tr>
                                ...
                                <td class="value"><input class="text" type="text" name="d_h_fs"
                                                         value="<?php echo getValue('d_h_fs') == "" ? 0 : getValue('d_h_fs'); ?>"
                                                         maxlength="60"></td>
                            ...
                            <tr>
                                ...
                                <td class="value"><input class="text" type="text" name="d_h_db"
                                                         value="<?php echo getValue('d_h_db') == "" ? 0 : getValue('d_h_db'); ?>"
                                                         maxlength="60"></td>
                                <td class="research"></td>
                            </tr>
                            </tbody>
                        ...
                        <table cellpadding="1" cellspacing="1">
                                ...
                                <td class="value">
                                    <?php if ($tribe != 4) { ?>
                                        <input class="text" type="text" name="ew2"
                                               value="<?php echo getValue('ew2') == "" ? 1 : getValue('ew2'); ?>"
                                               maxlength="5">
                                    <?php
                                    } else {
                                        echo '100';
                                ...
                                <td class="value">
                                    <?php if ($tribe != 4) { ?>
                                        <input class="text" type="text" name="stonemason"
                                               value="<?php echo getValue('stonemason') == "" ? 0 : getValue('stonemason'); ?>"
                                               maxlength="2">
                                    <?php
                                    } else {
                                        echo '0';
                            ...
                            <?php
                                ...
                                echo '<tr><td class="ico"><img src="img/x.gif" class="gebIcon ' . $class . '" title="' . $title . '" /></td>'
                                    ...
                                    . '<td class="value">';
                                if ($tribe != 4) {
                                    echo '<input class="text" type="text" name="wall" value="' . (getValue('wall') == "" ? 0 : getValue('wall'))
                                ...
                                <td class="value">
                                    <?php if ($tribe != 4) { ?>
                                        <input class="text" type="text" name="palast"
                                               value="<?php echo getValue('palast') == "" ? 0 : getValue('palast'); ?>"
                                               maxlength="2">
                                    <?php
                                    } else {
                                        echo '0';
                                ...
                                <?php
                                    for ($i = $start; $i <= $end; $i++) {
                                        echo '<tr>'
                                            . '<td class="ico"><img src="img/x.gif" class="unit u' . $i . '" alt="' . constant('U' . $i) . '" title="' . constant('U' . $i) . '"></td>'
                                            . '<td class="desc">' . $technology->unarray[$i] . '</td>'
                                            . '<td class="value"><input class="text" type="text" name="eu_' . $i . '" value="' . getValue('eu_' . $i) . '" maxlength="60"></td>'
                                            . '<td class="research"><input class="text" type="text" name="ea_' . ($i - $start + 1) . '" value="' . getValue('ea_' . ($i - $start + 1)) . '" maxlength="2"></td>'
                                            . '</tr>';
                                    }
                                ?>
                                </tbody>
                            ...
                            <table cellpadding="1" cellspacing="1">
                                ...
                                <tr>
                                    ...
                                    <td class="value"><input class="text" type="text" name="e_h_fs<?php echo $tribe ?>"
                                                             value="<?php echo getValue('e_h_fs' . $tribe) == "" ? 0 : getValue('e_h_fs' . $tribe); ?>"
                                                             maxlength="60"></td>
                                    <td class="research"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="value"><input class="text" type="text" name="e_h_db<?php echo $tribe ?>"
                                                             value="<?php echo getValue('e_h_db' . $tribe) == "" ? 0 : getValue('e_h_db' . $tribe); ?>"
                                                             maxlength="60"></td>
                                    <td class="research"></td>
                                </tr>
                                </tbody>
