            ...
            if(count($enforcetome) > 0) {
                ...
                $colspan = 10+$enforce['u11'];
                    if($enforce['from']!=0){
                        ...
                        $output .= "نیروهای ".$info['username']." در دهکده شما";
...
<div id="raidList">
    ...
    if(!$session->goldclub) {
        ?>
    <div class="build_desc"><p>با فعال سازی کلوپ طلایی متوانید نیرو هایتان را گریز دهید و در هنگام حمله به دهکده، آنها را به خارج از دهکده بفرستید تا از آسیب در امان بمانند.</p>
