                    ...
                    <div class="action">
                        <div class="details">
                            <div class="tit">
                                ...
                                <span class="furtherInfo">(تربیت شده:  <?php echo $village->unitarray['u99']; ?>)</span>
                            </div>
                            ...
                            <span class="value">تعداد</span> <input type="text" class="text" name="t999" value="0" maxlength="<?=MAXLENGHT?>"><span class="value">
    ...
    <table cellpadding=\"1\" cellspacing=\"1\" class=\"under_progress\">
        ...
        foreach($trainlist as $train) {
            ...
            echo "<img class=\"unit u".$train['unit']."\" src=\"".GP_LOCATION2."x.gif\" alt=\"".U99."\" title=\"".U99."\" />";
