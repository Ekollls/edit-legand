            ...
            echo "<div class=\"action first\">
                	<div class=\"bigUnitSection\">
						...
						<a href=\"#\" class=\"zoom\" onclick=\"return Travian.Game.unitZoom(".$i.");\">
							<img class=\"zoom\" src=\"".GP_LOCATION2."x.gif\" alt=\"zoom in\">
						</a>
					</div>
					<div class=\"details\">
						<div class=\"tit\">
							<a ><img class=\"unit u".$i."\" src=\"".GP_LOCATION2."x.gif\" alt=\"".$technology->getUnitName($i)."\"></a>
							<a >".$technology->getUnitName($i)."</a>
							<span class=\"furtherInfo\">(تربیت شده: ".$village->unitarray['u'.($i-($session->tribe-1)*10)].")</span>
						</div>
                        <div class=\"showCosts\">
                        <span class=\"resources r1\"><img class=\"r1\" src=\"".GP_LOCATION2."x.gif\" alt=\"Fa\">".(${'u'.$i}['wood']*3)."</span>
                        <span class=\"resources r2\"><img class=\"r2\" src=\"".GP_LOCATION2."x.gif\" alt=\"Agyag\">".(${'u'.$i}['clay']*3)."</span>
                        <span class=\"resources r3\"><img class=\"r3\" src=\"".GP_LOCATION2."x.gif\" alt=\"Vasérc\">".(${'u'.$i}['iron']*3)."</span>
                        <span class=\"resources r4\"><img class=\"r4\" src=\"".GP_LOCATION2."x.gif\" alt=\"Búza\">".(${'u'.$i}['crop']*3)."</span>
                        <span class=\"resources r5\"><img class=\"r5\" src=\"".GP_LOCATION2."x.gif\" alt=\"Búzafogyasztás\">".${'u'.$i}['pop']."</span>
                        <div class=\"clear\"></div>
                        <span class=\"clocks\"><img class=\"clock\" src=\"".GP_LOCATION2."x.gif\" alt=\"óra\">";$dur=round((${'u'.$i}['time'] * ($bid30[$village->resarray['f'.$id]]['attri'] * ($building->getTypeLevel(41)>=1?(1/$bid41[$building->getTypeLevel(41)]['attri']):1) / 100) / SPEED * $art*$bonuses['stable']),5);
