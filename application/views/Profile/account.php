...
<table cellpadding="1" cellspacing="1" id="change_pass" class="transparent">
	<tbody>
		<tr>
    <th><?php echo ACC2; ?></th>
...
<table class="sitters transparent">
            ...
            <th>
                ...
                echo "<button type=\"button\" value=\"del\" class=\"icon\" onclick=\"window.location.href = 'options.php?s=3&e=2&id=".$session->sit1."&a=".$session->checker."&type=1'; return false;\"><img src=\"".GP_LOCATION2."x.gif\" class=\"del\" alt=\"helyettes\"></button>";
        ...
        <tr>
            <th>
                ...
                if($session->sit2 != 0) {
                    ...
                    echo "<button type=\"button\" value=\"del\" class=\"icon\" onclick=\"window.location.href = 'options.php?s=3&e=2&id=".$session->sit2."&a=".$session->checker."&type=2'; return false;\"><img src=\"".GP_LOCATION2."x.gif\" class=\"del\" alt=\"helyettes\"></button>";
...
$sitee = $database->getSitee($session->uid);
    ...
    if(count($sitee[0])){
        ...
        echo "<button type=\"button\" value=\"del\" class=\"icon\" onclick=\"window.location.href = 'options.php?s=3&e=3&id=".$session->uid."&owner=".$sitee[0]['id']."&a=".$session->checker."&type=1'; return false;\"><img src=\"".GP_LOCATION2."x.gif\" class=\"del\" alt=\"helyettes\"></button>";
        ...
        <tr>
            <th>
                ...
                if(count($sitee[1])){
                    ...
                    echo "<button type=\"button\" value=\"del\" class=\"icon\" onclick=\"window.location.href = 'options.php?s=3&e=3&id=".$session->uid."&owner=".$sitee[1]['id']."&a=".$session->checker."&type=2'; return false;\"><img src=\"".GP_LOCATION2."x.gif\" class=\"del\" alt=\"helyettes\"></button>";
...
<p>
اگر شما به عنوان مالک حساب غیرفعال باشید، دسترسی نماینده مسدود خواهد شد. هر روز فعالیتی که در عضویت دارید ممکن است با یک روز دیگر فعالیت برای نماینده برابری کند. اگر چند روز غیبت کنید، این کار باعث می شود روزهای فعال نماینده مصرف شود.
<?php
/*
if($form->getError("email") != "") {
echo "<span class=\"error\">".$form->getError('email')."</span>";
...
/*echo "<a href=\"options.php?s=3&delcancel=1\"><img
		class=\"del\" src=\"".GP_LOCATION2."x.gif\" alt=\"Cancel process\"
