...
switch ($medal['categorie']) {
    ...
    if(isset($bonus[$medal['id']])){
        ...
        $profiel = preg_replace("/\[#".$medal['id']."]/is",'<img class="'.$medal['img'].'" src="img/t/'.$medal['img'].'.gif" title="'.$titel.'
<br />'.$lang['profile'][10].': '.$medal['week'].'">', $profiel, 1);
$profiel = preg_replace("/\[#".$medal['id']."]/is",'<img class="'.$medal['img'].'" src="img/t/'.$medal['img'].'.gif" title="'.$titel.'
<br />'.$lang['profile'][10].': '.$medal['week'].'">', $profiel, 1);
    } else {
        $profiel = preg_replace("/\[#".$medal['id']."]/is",'<img class="'.$medal['img'].'" src="img/t/'.$medal['img'].'.gif" title="'.$lang['profile'][9].': '.$titel.'<br />'.$lang['profile'][10].': '.$medal['week'].'<br />'.$lang['profile'][11].': '.$medal['plaats'].'<br />'.$woord.': '.$medal['points'].'<br />">', $profiel, 1);
        $profiel = preg_replace("/\[#".$medal['id']."]/is",'<img class="'.$medal['img'].'" src="img/t/'.$medal['img'].'.gif" title="'.$lang['profile'][9].': '.$titel.'<br />'.$lang['profile'][10].': '.$medal['week'].'<br />'.$lang['profile'][11].': '.$medal['plaats'].'<br />'.$woord.': '.$medal['points'].'<br />">', $profiel, 1);
    }
}
