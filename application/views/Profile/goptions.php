...
<table class="transparent set" cellpadding="1" cellspacing="1" id="timeSettings">
	...
	<h4 class="round spacer">لودينگ خودكار سايت در 00:00:00 </h4>
<table class="transparent set" cellpadding="1" cellspacing="1" id="reloadSettings">
		<tbody>
		<tr>
			<th>
			انتخاب کنید:</th>
			<td>
				<select name="reloadStatus">
					
					<option value="1" <?php if($session->autoreload == '1'){ echo 'selected="selected"'; } ?>>ریلود صفحه انجام شود</option>
                   <p>
				   <option value="3" <?php if($session->autoreload != '1'){ echo 'selected="selected"'; } ?>>ریلود صفحه انجام نشود</option>
                </select>
			</td>
		</tr>
		</tbody>
...
*/ ?>
    <div class="submitButtonContainer">
		<button type="submit" value="save" name="s1" id="btn_ok" class="textButtonV1 green  disabled" disabled="">
