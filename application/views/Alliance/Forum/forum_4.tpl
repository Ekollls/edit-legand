...
//var_dump($rows);die();
        if ($rows[0]['leader'] != $session->uid && $database->check_forumRules( $session->uid)) {
...
<h4 class="round"><?php echo $CatName; ?></h4>
		...
		<td class="none" colspan="4">'.AL_NOTOPIC.'</td>
            ...
            <div class="buttonBox">
                <button type="button" value="Post new thread" id="button528a506e61994" class="textButtonV1 green  "
