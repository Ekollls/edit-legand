...
if (count($allianceInvitations) == 0) {
	...
	$invited = $database->RemoveXSS($database->getUserField($invit['uid'],'username',0));
        ...
        echo "<button type=\"button\" value=\"del\" class=\"icon\" onclick=\"window.location.href = '?o=4&s=5&d=".$invit['id']."'; return false;\"><img class=\"del\" src=\"".GP_LOCATION2."x.gif\" alt=\"Cancel\" title=\"Cancel\" /></button></td><td>";
