<?php
    ...
    $limit2 = "and (ntype=9 or ntype=10 or ntype=11 or ntype=12 or ntype=13 or ntype=14 or ntype=15 or ntype=16 or ntype=17 or ntype=18 or ntype=19)";
    ...
    $sql2 = mysqli_query($database->connection,"SELECT * FROM $prefix WHERE uid = " . $session->uid . " and archive=0 " . $limit2 . " ORDER BY time DESC " . $limit);
    $paginationDisplay = "";
