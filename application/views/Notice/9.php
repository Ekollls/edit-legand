			...
			<div class="adventureHeader">
				<div class="headline">
					<div class="from">
						...
						<img class="roleIcon" src="<?=GP_LOCATION2;?>svg/combat/svgAttack.svg" alt="">
						<h2>ماجراجویی</h2>
					</div>
					<div class="to">
		...
		<tr>
            ...
            <?php
           	if($dataarray[1]){
				...
				echo ' ('.round($dataarray[3]).'x '.constant('U'.(($session->tribe-1)*10+$type)).')';
							$outputList .= "<div class=\"reportInfoIcon\"><img title=\"(".$dataarray[3]."x)\" src=\"".GP_LOCATION2."x.gif\" class=\"unit u".(($session->tribe-1)*10+$type)."\"\"></div>";
				}else{
