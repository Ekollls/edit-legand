    ...
    <div class="header">
        ...
        <div class="outcome">
            <div class="arrowWrapper">
                ...
                <img class="losses attack" src="<?=GP_LOCATION2;?>svg/combat/svgAttackLost.svg">
                <img class="loot lootHalf" src="<?=GP_LOCATION2;?>svg/combat/svgSkull.svg">
            </div>
        </div>
...
echo "</tr></tbody>"; ?>
    ...
    <div class="troopHeadline ">
        <div >
        <a class="player" href="spieler.php?uid=<?php echo $dataarray[27]; ?>"><?php echo $dataarray[28]; ?></a> از <a class="village" href="karte.php?d=<?php echo $dataarray[29]; ?>&amp;c=<?php echo $generator->getMapCheck($dataarray[29]); ?>"><?php echo $dataarray[30]; ?></a></p>
            </div>
