...
<div id="reportWrapper">
    ...
    <div class="header">
        <div class="avatar">
            ...
            <img src="<?=GP_LOCATION2;?>svg/combat/svgAttack.svg" alt="attack">
        </div>
        <h2>حمله</h2>
        <div class="outcome">
            <div class="arrowWrapper">
                ...
                <img class="losses attack" src="<?=GP_LOCATION2;?>svg/combat/svgAttack.svg">
                <img class="loot lootHalf" src="<?=GP_LOCATION2;?>svg/combat/svgLootHalf.svg">
            </div>
        </div>
...
for($i=$start;$i<=($start+9);$i++) {
	echo "<td class=\"uniticon\"><img src=\"".GP_LOCATION2."x.gif\" class=\"unit u$i\" title=\"".constant('U'.$i)."\" alt=\"\" /></td>";
}
	echo "<td class=\"uniticon last\"><img src=\"".GP_LOCATION2."x.gif\" class=\"unit uhero\" title=\"Hero\" alt=\"Hero\" /></td>";
    ...
    <tr>
        ...
        <?php
            if ($dataarray[29]+$dataarray[30]+$dataarray[27]+$dataarray[28] == 0) {
                ...
                echo"\" src=\"".GP_LOCATION2."x.gif\" class=\"carry empty\">";
            } elseif ($dataarray[29]+$dataarray[30]+$dataarray[27]+$dataarray[28] != $dataarray[31]) {
                echo "<img title=\"";
                echo ($dataarray[29]+$dataarray[30]+$dataarray[27]+$dataarray[28])."/".$dataarray[31];
                echo"\" src=\"".GP_LOCATION2."x.gif\" class=\"carry half\">";
            } else {
                echo"<img title=\"";
                echo ($dataarray[29]+$dataarray[30]+$dataarray[27]+$dataarray[28])."/".$dataarray[31];
                echo"\" src=\"".GP_LOCATION2."x.gif\" class=\"carry full\">";
            }
        ?>
...
for($y=0;$y<=MAX_TRIBE-1;$y++) {
   ...
   // var_dump($database->getUserInfo($dataarray[37])['tribe']);die();
...
?>
   ...
   <div class="header">
        <div class="avatar">
            <i class="tribeIcon bigTribe2"> </i>
            <img src="<?=GP_LOCATION2;?>svg/combat/svgDefend.svg" alt="دفاع">
        </div>
        <h2>دفاع</h2>
        <div class="outcome">
            <div class="arrowWrapper">
                <svg class="outcomeArrow" viewBox="0 0 20 20" preserveAspectRatio="none">
                    <path d="M0 0L20 10L0 20z"></path>
                            ...
                            <img class="losses defend" src="<?=GP_LOCATION2;?>svg/combat/svgDefend.svg">
                                </div>
    </div>
    <div class="troopHeadline ">
        <div >

        <?php if($dataarray[41]==$y+1){ echo'<a class="player" href="spieler.php?uid='.$dataarray[37].'">'.$dataarray[38].'</a> از <a class="village" href="karte.php?d='.$dataarray[39].'&amp;c='.$generator->getMapCheck($dataarray[39]).'">'.$dataarray[40].'</a></p>'; } else { echo OTPRAV2; } ?>
            </div>
...
for($i=$y*10+1;$i<=$y*10+10;$i++) {
	echo "<td><img src=\"".GP_LOCATION2."x.gif\" class=\"unit u$i\" title=\"".constant('U'.$i)."\" alt=\"\" /></td>";
}
	echo "<td class=\"uniticon last\"><img src=\"".GP_LOCATION2."x.gif\" class=\"unit uhero\" title=\"Hero\" alt=\"Hero\" /></td>";
echo "</tr><tr><th><i class=\"troopCount\"> </i></th>";
for($i=$k;$i<=$k+9;$i++) {
