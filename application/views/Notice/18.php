...
echo "<td class=\"uniticon last\"><img src=\"".GP_LOCATION2."x.gif\" class=\"unit u$i\" title=\"".constant('U'.$i)."\" alt=\"\" /></td>";
...
?>
        ...
        ?>
        <?php //echo number_format($dataarray[29]+$dataarray[30]+$dataarray[27]+$dataarray[28]); 
        ?></div></td></tr></tbody>
</tbody>
...
for($y=0;$y<=MAX_TRIBE-1;$y++) {
 ...
 ?>
    ...
    <div class="header">
        <div class="avatar">
            <i class="tribeIcon bigTribe2"> </i>
            <img src="<?=GP_LOCATION2;?>svg/combat/svgDefend.svg" alt="Defense">
        </div>
        <h2>Defense</h2>
        <div class="outcome">
            <div class="arrowWrapper">
    ...
    <div class="troopHeadline ">
		...
		<tbody class="units">
                ...
                for($i=$y*10+1;$i<=$y*10+10;$i++) {
                    echo "<td class=\"uniticon\"><img src=\"".GP_LOCATION2."x.gif\" class=\"unit u$i\" title=\"\" alt=\"\" /></td>";
                }
