...
<div id="reportWrapper">
    ...
    <div class="body">
        ...
        <div class="headline">
            <div class="from">
                ...
                <img class="roleIcon" src="<?=GP_LOCATION2;?>svg/combat/svgDefend.svg" alt="">
                <h2>ناتار</h2>
            </div>
            <div class="to">
        ...
        <?php $oCoor = $database->getCoor($dataarray[11]); ?>
            ...
            از آبادی <a class="" href="karte.php?x=<?php echo $oCoor['x']; ?>&amp;y=<?php echo $oCoor['y']; ?>">&lrm;&#8237;<span class="coordinates coordinatesWrapper"><span class="coordinateX">(<?php echo $oCoor['x']; ?></span><span class="coordinatePipe">|</span><span class="coordinateY"><?php echo $oCoor['y']; ?>)</span></span>&#8236;&lrm;</a>        </div>
    </div>
    ...
    <tr><th class="coords"></th>
                    ...
                    for($i=31;$i<=40;$i++) {
                        if($i==40){$class=' last';}
                        echo "<td class='$class'><img src=\"".GP_LOCATION2."x.gif\" title=\"".constant('U'.$i)."\" class=\"unit u$i\" title=\"\" alt=\"\" /></td>";
                    }
?></tbody>
