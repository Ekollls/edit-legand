<div id="reportWrapper">
    ...
    <div class="header">
        ...
        <div >
            ...
            <a class="player" href="spieler.php?uid=<?=$dataarray[0]?>"><?=$dataarray[1]?></a> <?php
              if($all['ntype']!=26){
                echo  REPORT_FROM_VIL;
             }else{
             echo REPORT_FIN_VIL;        
                 }
                 ?> <a class="village" href="karte.php?d=<?=$dataarray[2]."&amp;c=".$generator->getMapCheck($dataarray[2]); ?>"><?=$dataarray[3]?></a>
        </div>
        <!--
        <div class="toolList">
