                ...
                if($i==9 and ($technology->getTech(9))==1 or $i==10){
                    if ($slots['settlers']>0  || $slots['chiefs']>0 ) {
                        ...
                        echo "<div class=\"action first\">
                                ...
                                <img class=\"unitSection u".$unit."Section\" src=\"".GP_LOCATION2."x.gif\" alt=\"".$technology->getUnitName($unit)."\">
                                </a>
                                ...
                                <div class=\"details\">
                                <div class=\"tit\">
                                    <a href=\"#\" onclick=\"return Travian.Game.iPopup(".$unit.", 1);\"><img class=\"unit u".$i."\" src=\"".GP_LOCATION2."x.gif\" alt=\"".$technology->getUnitName($unit)."\"></a>
                                    <a href=\"#\" onclick=\"return Travian.Game.iPopup(".$unit.", 1);\">".$technology->getUnitName($unit)."</a>
                                    <span class=\"furtherInfo\">(تربیت شده:  ".$village->unitarray['u'.($unit-($session->tribe-1)*10)].")</span>
                                </div>
