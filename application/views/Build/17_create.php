...
?>						</select>
				...
				<tr>
					<th>
						<?=rinok50?>:					</th>
					<td>
						<img class="r1" src="img/x.gif" alt="Wood" title="Wood"> <input class="text" type="text" name="r1" id="r1" value="0" maxlength="15" tabindex="1" style="width:50px;">
                        <img class="r2" src="img/x.gif" alt="Clay" title="Clay"> <input class="text" type="text" name="r2" id="r2" value="0" maxlength="15" tabindex="1" style="width:50px;">
                        <img class="r3" src="img/x.gif" alt="Iron" title="Iron"> <input class="text" type="text" name="r3" id="r3" value="0" maxlength="15" tabindex="1" style="width:50px;">
                        <img class="r4" src="img/x.gif" alt="Crop" title="Crop"> <input class="text" type="text" name="r4" id="r4" value="0" maxlength="15" tabindex="1" style="width:50px;">
