<div id="build" class="gid29">
       <div class="clear"></div>
	<h4 class="round">تربیت نیروها</h4>
    <?php if ($building->getTypeLevel(29) > 0) { ?>
        <form method="POST" name="snd" action="build.php">
           ...
           // var_dump($art);die();
                ...
                for ($i=($session->tribe-1)*10+1;$i<=($session->tribe-1)*10+4;$i++) {
                    if ($i <> 4 && $i <> 23 && $i <> 24 && $i <> 54 && $i <> 63 && $i <> 64 &&($technology->getTech((($i)-(( $session->tribe-1)*10))) || $i%10 == 1)) 
                    {
                        echo "<div class=\"action first\">
                                ...
                                <div class=\"details\">
                                <div class=\"tit\">
                                    <a href=\"#\" onclick=\"return Travian.Game.iPopup(".$i.", 1);\"><img class=\"unit u".$i."\" src=\"".GP_LOCATION2."x.gif\" alt=\"".$technology->getUnitName($i)."\"></a>
                                    ...
                                    $dur= round((${'u'.$i}['time'] * ($bid29[$village->resarray['f'.$id]]['attri'] / 100) / SPEED * $art*$bonuses['barrack']),5);
                                    ...
                                    if($session->gold >= 3 && $building->getTypeLevel(17) >= 1) {
                                        ?>
                                    <button type="button" class="gold  textButtonV1 gold   <?php echo $isDisabled ? 'disabled': ''; ?>"  onfocus="jQuery('button', 'input[type!=hidden]', 'select').focus(); event.stopPropagation(); return false;" id="button<?php echo $i; ?>">
            ...
            <button type="submit"  class="textButtonV1 green startTraining">
                <div class="button-container addHoverClick ">
                    <div class="button-background">
                        <div class="buttonStart">
                            <div class="buttonEnd">
