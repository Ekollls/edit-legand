...
<div class="clear"></div>
	<h4 class="round">تربیت سرباز های سواره</h4>
                ...
                for($i=$uniq;$i<=($session->tribe-1)*10+6;$i++) {
                    ...
                    if($technology->getTech(($i-($session->tribe-1)*10))) {
                        echo "<div class=\"action first\">
                                    ...
                                    <div class=\"details\">
                                        <div class=\"tit\">
                                            <a onclick=\"return Travian.Game.iPopup($i,1);\"><img class=\"unit u".$i."\" src=\"".GP_LOCATION2."x.gif\" alt=\"".$technology->getUnitName($i)."\"></a>
