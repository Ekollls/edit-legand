...
<?php
	if ($building->getTypeLevel(22) > 0) {
		...
		?>
		<div class="clear"></div>
		<h4 class="round">توسعه تجیزات نیروها در  <?php echo $village->vname; ?></h4>
		<?php
		$fail = $success = 0;
			...
			if($technology->meetRRequirement($i) && !$technology->getTech(($startTech)) && !$technology->isResearch(($startTech),1)) {
				...
				<div class=\"research\">
					...
					<div class=\"information contractWrapper\">
						<div class=\"title\">
						<a href=\"#\" onclick=\"return Travian.Game.iPopup(".$i.",1);\">
							<img class=\"unit u".$i."\" src=\"".GP_LOCATION2."x.gif\" alt=\"".$technology->getUnitName($i)."\">
						</a>
			...
			for($uc=($start+1),$xx=0;$uc<=$end;$uc++){
				...
				if(!$technology->meetRRequirement($uc) && !$technology->getTech($j)) {
					...
					echo"<div class=\"research\">
						<div class=\"bigUnitSection\"><a href=\"#\" onclick=\"return Travian.Game.iPopup(".$uc.",1);\"><img class=\"unitSection u".$uc."Section\" src=\"".GP_LOCATION2."x.gif\" alt=\"".constant('U'.$uc)."\"></a><a href=\"#\" class=\"zoom\" onclick=\"return Travian.Game.unitZoom(".$uc.");\"><img class=\"zoom\" src=\"".GP_LOCATION2."x.gif\" alt=\"zoom in\"></a></div>
						<div class=\"information contractWrapper\">
						<div class=\"title\">
							<a href=\"#\" onclick=\"return Travian.Game.iPopup(".$uc.",1);\">
								<img class=\"unit u".$uc."\" src=\"".GP_LOCATION2."x.gif\" alt=\"".constant('U'.$uc)."\">
							</a>
