...
<div class=\"build_details researches\">
	<div class=\"research\">
		<div class=\"information\">
			<div class=\"title\">
                <a>
                <img class=\"celebration celebrationSmall\" src=\"".GP_LOCATION2."x.gif\" alt=\"".ratusha14."\">
                </a>
                <a>".ratusha14."</a>
                <span class=\"points\">(100 ".ratusha11.")</span>
            </div>
        ...
        $totalNeed = $cel[$i]['wood'] + $cel[$i]['clay'] + $cel[$i]['iron'] + $cel[$i]['crop'];
                    ...
                    && (($cel[$i]['wood'] > $village->awood || $cel[$i]['clay'] > $village->aclay || $cel[$i]['iron'] > $village->airon || $cel[$i]['crop'] > $village->acrop) && $totalNeed <= $village->resourceSUM ) 
                      ...
                      //echo "&nbsp;&nbsp;<button id='button".crc32($i)."' type=\"button\" value=\"npc\" class=\"icon\">&nbsp;<img src=\"".GP_LOCATION2."x.gif\" style=\"margin-top:6px;\" class=\"npc\" alt=\"npc\"></button>";
                        ?>
                    <button type="button" class="textButtonV1 gold exchange <?php echo $isDisabled ? 'disabled': ''; ?>"  onfocus="jQuery('button', 'input[type!=hidden]', 'select').focus(); event.stopPropagation(); return false;" id="button<?=crc32($i)?>">
        ...
        //echo "<div class=\"clear\"></div></div>";
				if($inuse > $time){
                    ...
                    echo "<button type=\"button\" value=\"\" class=\"textButtonV1 green\" onclick=\"window.location.href = 'build.php?id=$id&type=1'; return false;\">
						<div class=\"button-container addHoverClick\">
  <div class=\"button-background\">
   <div class=\"buttonStart\">
    <div class=\"buttonEnd\">
...
<div class=\"title\">
<a>
<img class=\"celebration celebrationSmall\" src=\"".GP_LOCATION2."x.gif\" alt=\"".ratusha9."\">
</a>
<a>".ratusha9."</a>
<span class=\"points\">(400 ".ratusha11.")</span>
</div>
<div class=\"inlineIconList resourceWrapper\">
<div class=\"inlineIcon resource\"><i class=\"r1Big\"></i><span class=\"value value\">".$cel[$i]['wood']."</span></div>
<div class=\"inlineIcon resource\"><i class=\"r2Big\"></i><span class=\"value value\">".$cel[$i]['clay']."</span></div>
...
echo $generator->getTimeFormat(round($cel[$i]['time'] * ($bid24[$building->getTypeLevel(24)]['attri'] / 100)/SPEED));
                            ...
                            <script type="text/javascript">
                                window.addEvent('domready', function()
                                {
                                    if($('button<?=crc32($i)?>'))
                                    {
                                        $('button<?=crc32($i)?>').addEvent('click', function ()
                                        {
                                            window.fireEvent('buttonClicked', [this, {"type":"button","value":"Exchange resources","name":"","id":"button5487115a9b649","class":" textButtonV1 greengold ","title":"Click here to exchange resources.","confirm":"","onclick":"","dialog":{"cssClass":"white","draggable":false,"overlayCancel":true,"buttonOk":false,"saveOnUnload":false,"data":{"cmd":"exchangeResources","defaultValues":{"tid":"1","nr":"1","btyp":"1","r1":<?=(($cel[$i]['wood']))?>,"r2":<?=(($cel[$i]['clay']))?>,"r3":<?=(($cel[$i]['iron']))?>,"r4":<?=(($cel[$i]['crop']))?>,"supply":"1","pzeit":0,"max1":0,"max2":0,"max3":0,"max4":0,"max":0},"did":"<?=$village->wid;?>"}}}]);
                                        });
                                    }
                                });
                            </script>
        ...
        if($inuse > $time){
            ...
            echo "
                	<button type=\"button\" value=\"\" class=\"textButtonV1 green\" onclick=\"window.location.href = 'build.php?id=$id&type=2'; return false;\">
						<div class=\"button-container addHoverClick\">
  <div class=\"button-background\">
   <div class=\"buttonStart\">
    <div class=\"buttonEnd\">
