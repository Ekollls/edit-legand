...
?><div id="contract_building<?php echo $i; ?>" class="contract contractNew contractWrapper">
    ...
    <div class="lineWrapper">
        ...
        ?>
        <button type="button" class="gold  textButtonV1 gold   exchange <?php echo $isDisabled ? 'disabled': ''; ?>"  onfocus="jQuery('button', 'input[type!=hidden]', 'select').focus(); event.stopPropagation(); return false;" id="button<?php echo crc32(array_sum($uprequire)); ?>">
...
<?php
    if($bindicator == 2) {
        ...
        echo "<button type=\"button\" value=\"Upgrade level\" class=\"textButtonV1 green \" onclick=\"window.location.href = 'dorf2.php?а=$i&id=$id&c=".$session->checker."'; return false;\">
...
<div class=\"button-background\">
    ...
    if($bindicator == 88 || $session->goldclub && $building->master==0 && $bindicator < 8) {
        if($bindicate != 88){echo "</br>";}
            echo "<button type=\"button\" value=\"Upgrade level\" class=\"gold  textButtonV1 gold  \" onclick=\"window.location.href = 'dorf2.php?а=$i&id=$id&c=".$session->checker."'; return false;\">
<div class=\"button-container addHoverClick\" style=\"margin:1px -3px;\">
<div class=\"button-background\">
    <div class=\"buttonStart\">
        <div class=\"buttonEnd\">
...
echo '<div class="button-content">ساخت به کمک استاد بنا<img src="img/x.gif" class="goldIcon" alt=""><span class="goldValue">1</span>';
