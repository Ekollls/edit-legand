                ...
                for ($i = $start; $i <= ($start + 1); $i++) {
                    ...
                    if ($technology->getTech($ava)) {
                        echo "<div class=\"action first\">
                                ...
                                <div class=\"details\">
                                    <div class=\"tit\">
                                        <a href=\"#\" onclick=\"return Travian.Game.iPopup($i,1);\"><img class=\"unit u$i\" src=\"".GP_LOCATION2."x.gif\" alt=\"Paladin\"></a>
                                        <a href=\"#\" onclick=\"return Travian.Game.iPopup($i,1);\">".$technology->getUnitName($i)."</a>
                                        <span class=\"furtherInfo\">(تربیت شده: ".$village->unitarray['u'.$ava].")</span>
                                    </div>
