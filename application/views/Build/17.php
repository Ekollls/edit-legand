...
if(!isset($_GET['t']) || !in_array($_GET['t'],array(1,2,3,4,5))){
 ...
 ?>
    تعداد تاجران: &lrm;<?php echo $market->merchantAvail(); ?>/<?php echo $market->merchant; ?>    &lrm;<br>
    تعداد پیشنهادات  در معامله با بازیکنان: &lrm;<?php echo count($market->onmarket); ?>/<?php echo $market->merchant; ?>    &lrm;<br>
    تعداد کاروان های در راه: &lrm;<?php echo count($market->return) + count($market->sending); ?>/<?php echo $market->merchant; ?>    &lrm;
</div>
