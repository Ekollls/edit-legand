...
<table cellpadding=\"1\" cellspacing=\"1\" class=\"under_progress\">
    ...
    foreach ($trainlist as $train) {
        ...
        echo "<img class=\"unit u" . ($train['unit']>MAX_UNIT?$train['unit']-MAX_UNIT:$train['unit']) . "\" src=\"".GP_LOCATION2."x.gif\" alt=\"\" title=\"\" />";
    ...
    echo "<button type=\"button\"  class=\"gold ".($isDisabled ? 'disabled' : '')."\" ".($isDisabled ? '' : "onclick=\"window.fireEvent('startPaymentWizard', {
        data: {
            cmd: 'paymentWizard',
            goldProductId: '',
            goldProductLocation: '',
