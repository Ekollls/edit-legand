...
if(count($market->recieving) > 0) {
    ...
    foreach($market->recieving as $recieve) {
        ...
        echo "<img class=\"r1\" src=\"".GP_LOCATION2."x.gif\" alt=\"Lumber\" title=\"Lumber\" />".$recieve['wood']." | <img class=\"r2\" src=\"".GP_LOCATION2."x.gif\" alt=\"Clay\" title=\"Clay\" />".$recieve['clay']." | <img class=\"r3\" src=\"".GP_LOCATION2."x.gif\" alt=\"Iron\" title=\"Iron\" />".$recieve['iron']." | <img class=\"r4\" src=\"".GP_LOCATION2."x.gif\" alt=\"Crop\" title=\"Crop\" />".$recieve['crop']."</td></tr></tbody>";
        echo "</table>";
        $timer +=1;
    }
}
if(count($market->sending) > 0) {
    ...
    foreach($market->sending as $send) {
        ...
        echo "<img class=\"r1\" src=\"".GP_LOCATION2."x.gif\" alt=\"Lumber\" title=\"Lumber\" />".$send['wood']." | <img class=\"r2\" src=\"".GP_LOCATION2."x.gif\" alt=\"Clay\" title=\"Clay\" />".$send['clay']." | <img class=\"r3\" src=\"".GP_LOCATION2."x.gif\" alt=\"Iron\" title=\"Iron\" />".$send['iron']." | <img class=\"r4\" src=\"".GP_LOCATION2."x.gif\" alt=\"Crop\" title=\"Crop\" />".$send['crop']."</td></tr></tbody>";
        echo "</table>";
        $timer += 1;
    }
}
if(count($market->return) > 0) {
    ...
    foreach($market->return as $return) {
        ...
        echo "<td class=\"none\"><img class=\"r1\" src=\"".GP_LOCATION2."x.gif\" alt=\"Lumber\" title=\"Lumber\" />".$return['wood']." | <img class=\"r2\" src=\"".GP_LOCATION2."x.gif\" alt=\"Clay\" title=\"Clay\" />".$return['clay']." | <img class=\"r3\" src=\"".GP_LOCATION2."x.gif\" alt=\"Iron\" title=\"Iron\" />".$return['iron']." | <img class=\"r4\" src=\"".GP_LOCATION2."x.gif\" alt=\"Crop\" title=\"Crop\" />".$return['crop']."</td></tr>";
