	...
	if($units[$y]['from'] != 0){
		...
		echo "<table class=\"troop_details\" cellpadding=\"1\" cellspacing=\"1\"><thead><tr><td class=\"role\">
                  ...
                  for($i=$start;$i<=($end);$i++) {
                    ...
                    if($units[$y]['t11'] != 0 && $reinfowner == $session->uid) {
                  	echo "<td><img src=\"".GP_LOCATION2."x.gif\" class=\"unit uhero\" title=\"".$technology->getUnitName($i)."\" alt=\"".$technology->getUnitName($i)."\" /></td>";
                  }
...
<table class="troop_details" cellpadding="1" cellspacing="1">
	<thead>
		<tr>
			...
			<td colspan="<?php if($units[$y]['t11'] != 0) {echo"11";}else{echo"10";}?>"><a href="karte.php?d=<?php echo $units[$y]['from']."&c=".$generator->getMapCheck($units[$y]['from']); ?>"><?php echo "برگشت از  ".$vname; ?></a></td>
		</tr>
	</thead>
	<tbody class="units">
			<?php
      ...
      <tr><th>نیروها</th>
       ...
       <tr><th>منابع</th>
			...
			echo " <img src=\"".GP_LOCATION2."x.gif\" class=\"carry full\"> ".number_format($totalres)."/".number_format($totalcarry)."</div>";
            ?>
           </tr>
		   <?php } ?>
    </tbody>
