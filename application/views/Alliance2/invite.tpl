        ...
        <?php
            if (count($allianceInvitations) == 0) {
                ...
                foreach ($allianceInvitations as $invit) {
                    ...
                    echo "<button type=\"button\" value=\"del\" class=\"icon\" onclick=\"window.location.href = '?o=4&s=5&d=" . $invit['id'] . "'; return false;\"><img class=\"del\" src=\"".GP_LOCATION2."x.gif\" alt=\"" . AL_CANCEL . "\" title=\"Cancel\" /></button></td><td>";
