...
<div id="auction">
<div class="hero hero_auction hero hero_auctionBuy">
...
include_once "application/views/Auction/alt.php";
	...
	$outputList .= "<tr><td class=\"icon".$sStyle."\"><img class=\"itemCategory itemCategory_".$typeArray[$btype]."\" src=\"".GP_LOCATION2."x.gif\" title=\"".$Travian->getItemData($btype, $type)['name']."||".$Travian->getItemData($btype, $type)['title']."\"></td>";
    ...
    $outputList .= '<td class="bid"><a class="bidButton openedClosedSwitch switchDisabled" title="اول ۱۰ ماجراجویی را کامل کنید"><span class="errorMessage">شرکت در حراجی</span></a></td>';
}
	$outputList .= "</tr>";
    
	if(isset($_GET['a']) && $_GET['a']==$id){
    $outputList .= "<tr><td style=\"background-color: rgb(231, 231, 231) class=\"icon selected\"></td><td colspan=\"6\" style=\"background-color: rgb(231, 231, 231)\" class=\"name selected detail\">";
	$outputList .= "<form style=\"background-color: #e7e7e7\" class=\"auctionDetails\" id=\"auctionDetails".$_GET['a']."\"  action=\"hero_auction.php\" method=\"POST\">";
    ...
    $outputList .= "<div class=\"bidHeadline\">پیشنهاد برای  ".$num." × ".$Travian->getItemData($btype, $type)['name']."</div><div>";
    $outputList .= HEROAC19." <img title=\"silver\" class=\"silver\" src=\"".GP_LOCATION2."x.gif\"> <span>".($silver)."</span><br>".HEROAC20;
    ...
    $outputList .= "<span></span><br>پیشنهاد شما:<input class =\"boxadv\" class=\"maxBid text\" type=\"text\" name=\"maxBid\" value=\"".$minimum."\">";
    $outputList .= "<span> (حداقل <img title=\"silver\" class=\"silver\" src=\"".GP_LOCATION2."x.gif\"> ".$minimum.")</span>";
    $outputList .= '<div class="submitBid"><button  type="submit" class ="advn" class ="textButtonV1 green " ><div class="button-container addHoverClick ">
...
?>
<p>
<table class="currentBid" cellspacing="1" cellpadding="1"><thead><tr>
