...
<div style="width: 569px; margin-right: 10px;" id="auction">
<div id="filter">
...
include_once "application/views/Auction/alt.php";
	...
	$outputList .= "<tr><td class=\"".$sStyle."\"></td><td class=\"icon".$sStyle."\"><img class=\"itemCategory itemCategory_".$typeArray[$btype]."\" src=\"".GP_LOCATION2."x.gif\" title=\"".$Travian->getItemData($btype, $type)['name']."||".$Travian->getItemData($btype, $type)['title']."\"></td>";
	...
	if(isset($_GET['a']) && $_GET['a']==$id){
        ...
        $outputList .= "<tr><td class=\"icon selected\"></td><td colspan=\"6\" class=\"name selected detail\">";
        ...
        $outputList .= "<span> (min <img title=\"silver\" class=\"silver\" src=\"".GP_LOCATION2."x.gif\"> ".$minimum.")</span>";
        $outputList .= '<td class="icon selected"><div class="submitBid"><button type="submit" class="textButtonV1 green "><div class="button-container addHoverClick ">
...
include_once "application/views/Auction/alt.php";
	...
	$outputList .= "<td class=\"icon\"><img class=\"itemCategory itemCategory_".$typeArray[$btype]."\" src=\"".GP_LOCATION2."x.gif\" title=\"".$Travian->getItemData($btype, $type)['name']."||".$Travian->getItemData($btype, $type)['title']."\"></td>";
...
<p>
	...
	<div>
	<p>
        <button type="submit" class="textButtonV1 green" name="del" id="del">
