...
<div style="width: 560px; margin-right: 10px;" class="hero hero_auction hero hero_auctionSell">
<div id="auction">
...
include_once "application/views/Auction/alt.php";
    if($bids!=0){
    $outputList .= "<tr><td class=\"delete\"><img class=\"del inactive\" src=\"".GP_LOCATION2."x.gif\" title=\"Cancel\"></td><td class=\"icon\"><img class=\"itemCategory itemCategory_".$typeArray[$btype]."\" src=\"".GP_LOCATION2."x.gif\" title=\"".$Travian->getItemData($btype, $type)['title']."\"></td>";
    }else{
    $outputList .= "<tr><td class=\"delete\"><a href=\"?action=sell&abort=".$id."\"><img class=\"del\" src=\"".GP_LOCATION2."x.gif\" title=\"Cancel\"></a></td><td class=\"icon\"><img class=\"itemCategory itemCategory_".$typeArray[$btype]."\" src=\"".GP_LOCATION2."x.gif\" title=\"".$Travian->getItemData($btype, $type)['title']."\"></td>";
    }
...
<div class="boxes boxesColor gray ">
    ...
    <div class="boxes-contents cf"></div>
	
<div  class=""><div id="itemsToSale">
...
include_once "application/views/Auction/alt.php";
    ...
    $outputList .= "<tr><td class=\"icon\"><img class=\"itemCategory itemCategory_".$typeArray[$btype]." ".($Afinished[0]['finished']<$needadv ? 'disabled' : '')."\" src=\"".GP_LOCATION2."x.gif\" title=\"".$Travian->getItemData($btype, $type)['name']."||".$Travian->getItemData($btype, $type)['title']."\"></td>";
