...
<table class="table">
	...
	<tr>
		...
		<td class="addTroops"><img src="<?=GP_LOCATION2 ?>admin/en/u/<?php echo $tr;?>1.gif"></img> </td>
	...
	<tr>
		...
		<td><img src="<?=GP_LOCATION2 ?>admin/en/u/<?php echo $tr;?>2.gif"></img> </td>
	...
	<tr>
		...
		<td><img src="<?=GP_LOCATION2 ?>admin/en/u/<?php echo $tr;?>3.gif"></img> </td>
	...
	<tr>
		...
		<td><img src="<?=GP_LOCATION2 ?>admin/en/u/<?php echo $tr;?>4.gif"></img> </td>
	...
	<tr>
		...
		<td><img src="<?=GP_LOCATION2 ?>admin/en/u/<?php echo $tr;?>5.gif"></img> </td>
	...
	<tr>
		...
		<td><img src="<?=GP_LOCATION2 ?>admin/en/u/<?php echo $tr;?>6.gif"></img> </td>
	...
	<tr>
		...
		<td><img src="<?=GP_LOCATION2 ?>admin/en/u/<?php echo $tr;?>7.gif"></img> </td>
	...
	<tr>
		...
		<td><img src="<?=GP_LOCATION2 ?>admin/en/u/<?php echo $tr;?>8.gif"></img> </td>
	...
	<tr>
		...
		<td><img src="<?=GP_LOCATION2 ?>admin/en/u/<?php echo $tr;?>9.gif"></img> </td>
	...
	<tr>
		...
		<td><img src="<?=GP_LOCATION2 ?>admin/en/u/<?php echo $tr+1;?>0.gif"></img></td>
		...
		<td><img src="<?=GP_LOCATION2 ?>admin/en/u/hero.gif"></img></td>
	...
	<div align="right"><input type="image" border="0" src="<?=GP_LOCATION2 ?>admin/b/ok1.gif">
