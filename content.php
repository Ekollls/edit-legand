<div>
    <div class="custom-popup-content" id="popupHeader" class="" style="z-index: 6005;">
                ...
                <div class="dialogContainer">
                    <div class="dialogContents">
                        <form action="?" method="get" accept-charset="UTF-8">
                            ...
                            <div class="iconButton buttonFramed green withIcon rectangle info" style="display: none;">
                            </div>
                            <div id="closePopupBtn"
                                class="dialogCancelButton iconButton buttonFramed green withIcon rectangle cancel">
                            ...
                            <div class="content" id="dialogContent">
                                <div id="paymentWizard" class="buyGold selectPackage">
                                    <input class="paymentWizardKnowledgeBaseLink hide" type="hidden"
                                        name="knowledgeBaseLink" value="">
                                    ...
                                    <div class="accountBalance">
                                        <div class="inlineIcon " title=""><svg xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 51 51" class="goldCoin">
                                                <defs>
                                                    <linearGradient id="a" x1="25.5" x2="25.5" y1="2" y2="49"
                                                        gradientTransform="rotate(13.28 25.519 25.5)"
                                                    ...
                                                    <linearGradient id="b" x1="25.5" x2="25.5" y1="7.89" y2="43.19"
                                                        gradientTransform="rotate(67.5 25.502 25.498)"
                                                        gradientUnits="userSpaceOnUse">
                                                ...
                                                <circle cx="25.5" cy="25.5" r="23.5" fill="url(#a)"
                                                    transform="rotate(-13.28 25.5 25.519)"></circle>
                                                <circle cx="25.5" cy="25.5" r="17.52" fill="url(#b)"
                                                    transform="rotate(-67.5 25.498 25.502)"></circle>
                                                <path fill="#b47b34"
                                                    d="M42.3 25.5c-.39-22.38-33.21-22.38-33.6 0 .39 22.38 33.21 22.38 33.6 0z">
                                                </path>
                                                <path fill="#c48d3a"
                                                ...
                                                <path fill="#703e19"
                                                    d="M35.43 15.17h-1.76l-.38.55H18.43l-.37-.55h-1.77l-1 5.78L16 22l2.14-3.13h4.77v14.59c0 1.69-2.57 2.1-2.57 2.1v2.27h11v-2.27s-2.57-.41-2.57-2.1V18.88h4.77L35.7 22l.71-1z">
                                                </path>
                                                <path fill="#dbb561"
                                            ...
                                            <a style="top:-30px; left: -77px;" type="button" style="right:10px"
                                                id="tabFavorButton"
                                                class="icon contentTitleButton buttonFramed green withIcon rectangle"
                                                href="#" onclick="toggleDefaultTab(currentTab)">
                                                <svg viewBox="0 0 20 20" width="40" height="40"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <g class="outline">
                                                        <path
                                                            d="M10 15l-7-7 1.414-1.414L10 12.172l5.586-5.586L17 8l-7 7z" />
                                                    </g>
                                                    <g class="icon">
                                                        <path
                                                            d="M10 15l-7-7 1.414-1.414L10 12.172l5.586-5.586L17 8l-7 7z" />
                                                    </g>
                                                    <g class="inner-triangle">
                                                        <path d="M10 12l-4-4h8l-4 4z" fill="white" />
                                                    </g>
                                                </svg>
                                            ...
                                            <span class="value ajaxReplaceableGoldAmount">&#x202D;53&#x202C;</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="header">
                                        ...
                                        <div id="countrySelectionTemplate" class="">
                                            ...
                                            <div class="noCountryFound none hide">لا يوجد بلد يتطابق مع بحثك.</div>
                                            <div class="scrollableContent">
                                                <label class="countryListItem" data-country-native="الإمارات العربية"
                                                    data-country-english="United Arab Emirates">
                                                ...
                                                <label class="countryListItem" data-country-native="Österreich"
                                                    data-country-english="Austria">
                                                ...
                                                <label class="countryListItem" data-country-native="België"
                                                    data-country-english="Belgium">
                                                ...
                                                <label class="countryListItem" data-country-native="Bosna i Hercegovina"
                                                    data-country-english="Bosnia and Herzegovina">
                                                ...
                                                <label class="countryListItem" data-country-native="Brasil"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480"
                                                        ...
                                                        <path fill="#fff"
                                                            d="M444 286a125 125 0 0 0 6-20c-68-60-143-90-239-84a125 125 0 0 0-8 21c113-11 196 39 241 83z">
                                                        </path>
                                                        <path fill="#309e3a"
                                                            d="M414 252h2a3 3 0 0 0 0 2v2h3l-2-2-2-3a4 4 0 0 1 1-3h6l3 3a4 4 0 0 1-1 3h-2a2 2 0 0 0 0-2h-4a1 1 0 0 0 0 1l2 2 2 3v4h-7l-3-3a5 5 0 0 1 1-4zm-11-8h2a3 3 0 0 0 0 2v2h3l-2-2-2-3a4 4 0 0 1 0-3h6l3 3a4 4 0 0 1 0 3h-2a2 2 0 0 0 0-2h-4a1 1 0 0 0 0 1l2 2 2 2v4l-2 2h-5l-3-3a5 5 0 0 1 0-4zm-14-4l7-12 9 5v2l-6-4-2 3 6 4v2l-6-4-2 3 7 4v2l-9-6zm-21-17v-2l5 3-3 5h-6l-3-3a6 6 0 0 1-1-3 9 9 0 0 1 1-4l3-3h7l3 3a5 5 0 0 1 0 4h-3a3 3 0 0 0 0-2h-5l-3 3a6 6 0 0 0-1 4l2 2h3v-2h-3zm-90-22l2-14h4v10l4-9h4l-2 14h-3l2-11-4 11h-3v-11l-2 11h-3zm-14-2v-13h10v2h-8v3h7v2h-7v4h8v2h-11zm-47-8a9 9 0 0 1 1-4v-2h5l5 2a9 9 0 0 1 0 11l-5 2-5-2a7 7 0 0 1-2-5z">
                                                        </path>
                                                        <path fill="#f7ffff"
                                                            d="M219 191a5 5 0 0 0 1 4h6a5 5 0 0 0 1-4 5 5 0 0 0-1-4h-6a5 5 0 0 0-1 4z">
                                                        </path>
                                                        <path fill="#309e3a"
                                                            d="M233 199v-15h11v2a4 4 0 0 1-1 3h-1l2 2 2 3h-3l-2-3v-2h-3v6h-3z">
                                                        </path>
                                                        <path fill="#fff" d="M236 190v4z"></path>
                                                        <path fill="#309e3a"
                                                            d="M249 185h10v2a10 10 0 0 1 0 3v3l-2 2h-9v-10z"></path>
                                                        <path fill="#fff" d="M252 188v9h6v-3a8 8 0 0 0 0-3h-6z"></path>
                                                        <path fill="#309e3a"
                                                            d="M318 210l3-14h8l2 2a4 4 0 0 1 0 3v2h-8v5h-3z"></path>
                                                        <path fill="#fff" d="M323 200v4h5a2 2 0 0 0 0-1h-4z"></path>
                                                        <path fill="#309e3a"
                                                            d="M331 214l5-13 6 2h3v2a4 4 0 0 1 0 2l-2 2h-3v7h-3v-6h-2l-2 6h-3z">
                                                        </path>
                                                        <path fill="#fff" d="M336 207h6a2 2 0 0 0 0-1h-5v3z"></path>
                                                        <path fill="#309e3a"
                                                            d="M347 214l2-3h7l4 3a9 9 0 0 1-3 10h-5l-4-3a7 7 0 0 1 0-6z">
                                                        </path>
                                                        <path fill="#fff"
                                                            d="M350 214a5 5 0 0 0 0 4l2 2h3l2-3a5 5 0 0 0 0-4l-2-2h-3l-2 3z">
                                                        </path>
                                                        <path fill="#309e3a"
                                                            d="M374 233l6-12 5 3 3 2v2a4 4 0 0 1 0 2l-2 2h-3v8l-3-2v-6h-2l-3 5h-3z">
                                                        </path>
                                                        <path fill="#fff" d="M381 227h2l-2 3z"></path>
                                                        <path fill="#309e3a"
                                                            d="M426 259l3-3h7a7 7 0 0 1 3 4 7 7 0 0 1-1 5l-4 3h-5a7 7 0 0 1-3-4 7 7 0 0 1 1-5z">
                                                        </path>
                                                        <path fill="#fff"
                                                            d="M429 260a5 5 0 0 0-1 4l2 3h3l3-2a5 5 0 0 0 1-4l-2-3h-3l-3 2z">
                                                        </path>
                                                        <path fill="#309e3a"
                                                            d="M302 205l2-10 7 2v2h-5v2h5v2h-5v3h5v2l-7-2z"></path>
                                                    </svg>
                                                    <div class="country">Brasil</div>
                                                </label>
                                                <label class="countryListItem" data-country-native="Česká republika"
                                                    data-country-english="Czech Republic">
                                                ...
                                                <label class="countryListItem" data-country-native="Deutschland"
                                                    data-country-english="Germany">
                                                ...
                                                <label class="countryListItem" data-country-native="Danmark"
                                                    data-country-english="Denmark">
                                                ...
                                                <label class="countryListItem" data-country-native="España"
                                                    data-country-english="Spain">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480"
                                                        ...
                                                        <path fill="#ad1519"
                                                            d="M127 213h-3a3 3 0 0 1 0-2h21a2 2 0 0 1 0 1h-18"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M127 213h-3a3 3 0 0 1 0-2h21a2 2 0 0 1 0 1h-18z"
                                                            stroke-linejoin="round"></path>
                                                        <path fill="#c8b100"
                                                            d="M133 207c0-1 1-2 1-2s1 1 1 2-1 2-1 2-1-1-1-2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M133 207c0-1 1-2 1-2s1 1 1 2-1 2-1 2-1-1-1-2z"></path>
                                                        <path fill="#c8b100"
                                                            d="M134 207c0-1 0-2 1-2s1 1 1 2 0 2-1 2-1-1-1-2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M134 207c0-1 0-2 1-2s1 1 1 2 0 2-1 2-1-1-1-2z"></path>
                                                        <path fill="#c8b100" d="M135 204"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".28799999"
                                                            d="M135 204"></path>
                                                        <path fill="#c8b100" d="M136 204"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".28799999"
                                                            d="M136 204"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M135 204">
                                                        </path>
                                                        <path fill="#c8b100"
                                                            d="M135 213h-5l-3-3c1-1 3 1 5 4h5c2-3 4-4 5-4l-3 3h-5">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M135 213h-5l-3-3c1-1 3 1 5 4h5c2-3 4-4 5-4l-3 3h-5z">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M127 207c1-1 3 1 5 4m11-4c-1-1-3 1-5 4"></path>
                                                        <path fill="#c8b100" d="M128 215"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M128 215">
                                                        </path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M135 213z"
                                                            stroke-linejoin="round"></path>
                                                        <path fill="#fff" d="M132 214"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M132 214z"></path>
                                                        <path fill="#ad1519" d="M135 215"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M135 215">
                                                        </path>
                                                        <path fill="#058e6e" d="M130 215"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M130 215">
                                                        </path>
                                                        <path fill="#ad1519" d="M127 215"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M127 215">
                                                        </path>
                                                        <path fill="#fff" d="M137 214"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M137 214z"></path>
                                                        <path fill="#058e6e" d="M139 215"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M139 215">
                                                        </path>
                                                        <path fill="#ad1519" d="M142 215"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M142 215">
                                                        </path>
                                                        <path fill="#ad1519" d="M135 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M135 217z"
                                                            stroke-linejoin="round"></path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M135 208">
                                                        </path>
                                                        <path fill="#c8b100" d="M133 210"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M133 210">
                                                        </path>
                                                        <path fill="#c8b100" d="M136 210"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M136 210">
                                                        </path>
                                                        <path fill="#c8b100" d="M129 209"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M129 209">
                                                        </path>
                                                        <path fill="#c8b100" d="M128 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M128 211">
                                                        </path>
                                                        <path fill="#c8b100" d="M131 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M131 211">
                                                        </path>
                                                        <path fill="#c8b100" d="M127 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M127 211">
                                                        </path>
                                                        <path fill="#c8b100" d="M129 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M129 211z"></path>
                                                        <path fill="#c8b100" d="M140 209"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M140 209">
                                                        </path>
                                                        <path fill="#c8b100" d="M141 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M141 211">
                                                        </path>
                                                        <path fill="#c8b100" d="M138 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M138 211">
                                                        </path>
                                                        <path fill="#c8b100" d="M142 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M142 211">
                                                        </path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M150 317h-30v2h30v-2z"></path>
                                                        <path fill="#ccc" d="M150 320h-30v2h30v-2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M150 320h-30v2h30v-2"></path>
                                                        <path fill="#005bbf" d="M150 322h-30v2h30v-2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M150 322h-30v2h30v-2"></path>
                                                        <path fill="#ccc" d="M150 327h-30v-2h30v2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M150 327h-30v-2h30v2"></path>
                                                        <path fill="#005bbf" d="M150 329h-30v-2h30v2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M150 329h-30v-2h30v2z"></path>
                                                        <path fill="#c8b100"
                                                            d="M126 308a3 3 0 0 1-3 3h22a3 3 0 0 1-3-3h-16"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M126 308a3 3 0 0 1-3 3h22a3 3 0 0 1-3-3h-16z"
                                                            stroke-linejoin="round"></path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M124 317h22v-6h-22v6z"></path>
                                                        <path fill="#ad1519"
                                                            d="M122 287l-3 3 2 2c2 1 2 3 2 4a6 6 0 0 0 0-9"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M122 287l-3 3 2 2c2 1 2 3 2 4a6 6 0 0 0 0-9z"></path>
                                                        <path fill="#ccc" d="M127 306h16v-77h-16z"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M138 229v76m2-76v76m-13 0h16v-76h-16z"></path>
                                                        <path fill="#ad1519"
                                                            d="M158 258l-16-3h-7c-9 2-16 5-16 8l-4-8c-1-3 7-8 18-9h9l16 2v9">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M158 258l-16-3h-7c-9 2-16 5-16 8l-4-8c-1-3 7-8 18-9h9l16 2v9"
                                                            stroke-linejoin="round"></path>
                                                        <path fill="#ad1519" d="M127 267c-4 0-7-1-8-3s1-3 4-4h4v7">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M127 267c-4 0-7-1-8-3s1-3 4-4h4v7"></path>
                                                        <path fill="#ad1519" d="M142 261l6 2c0 1-2 3-6 5v-8"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M142 261l6 2c0 1-2 3-6 5v-8"></path>
                                                        <path fill="#ad1519"
                                                            d="M117 282c0-1 4-4 10-6l8-3c8-4 14-8 14-9s1 8 1 8-5 6-12 9l-10 4c-4 2-9 4-8 5v-8">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M117 282c0-1 4-4 10-6l8-3c8-4 14-8 14-9s1 8 1 8-5 6-12 9l-10 4c-4 2-9 4-8 5v-8z"
                                                            stroke-linejoin="round"></path>
                                                        <path fill="#c8b100"
                                                            d="M126 254c2-1 3-2 3-3h-5l2 6h2v-3zm-1-3h2a1 1 0 0 1 0 1h-1v-2m7-2h-2v6h2v-5m8 5l3-6h-1l-2 5-2-4h-2l3 6h1m9-5h-1c-2 0-3 1-3 2s3 2 3 3h-2c2 0 3-1 3-2s-3-2-3-3h3">
                                                        </path>
                                                        <path fill="#ad1519" d="M278 212h-10l2-2h16l2 2h-10"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".259"
                                                            d="M278 212h-10l2-2h16l2 2h-10z"></path>
                                                        <path fill="#c8b100"
                                                            d="M277 208c0-1 1-2 1-2s1 1 1 2-1 2-1 2-1-1-1-2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M277 208c0-1 1-2 1-2s1 1 1 2-1 2-1 2-1-1-1-2z"></path>
                                                        <path fill="#c8b100" d="M277 208"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M277 208z"></path>
                                                        <path fill="#c8b100" d="M271 215"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M271 215">
                                                        </path>
                                                        <path fill="#c8b100" d="M278 218"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M278 218z"></path>
                                                        <path fill="#fff" d="M284 208"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".20200001"
                                                            d="M284 208zm0-1zm-1-1zm-1 0zm-1 0z"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M288 211a3 3 0 0 0-3-3h-1" stroke-linecap="round"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M283 209a2 2 0 0 0-3-2h-2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".20200001"
                                                            d="M288 210zm0-2zm-1-1zm-1-1zm-1 0z"></path>
                                                        <path fill="#c8b100" d="M285 213"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M285 213z"></path>
                                                        <path fill="#fff" d="M271 208"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".20200001"
                                                            d="M271 208zm0-1zm1-1zm1 0zm1 0z"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M268 211a3 3 0 0 1 3-3h1" stroke-linecap="round"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M273 209a2 2 0 0 1 3-2h2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".20200001"
                                                            d="M267 210zm0-2zm1-1zm1-1zm1 0z"></path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M278 215">
                                                        </path>
                                                        <path fill="#058e6e" d="M273 215"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M273 215">
                                                        </path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M282 215">
                                                        </path>
                                                        <path fill="#ad1519" d="M285 215"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M285 215">
                                                        </path>
                                                        <path fill="#ad1519" d="M278 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M278 217z"
                                                            stroke-linejoin="round"></path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M278 208">
                                                        </path>
                                                        <path fill="#c8b100" d="M276 210"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M276 210">
                                                        </path>
                                                        <path fill="#c8b100" d="M280 210"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M280 210">
                                                        </path>
                                                        <path fill="#c8b100" d="M272 209"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M272 209">
                                                        </path>
                                                        <path fill="#c8b100" d="M271 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M271 211">
                                                        </path>
                                                        <path fill="#c8b100" d="M275 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M275 211">
                                                        </path>
                                                        <path fill="#c8b100" d="M270 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M270 211">
                                                        </path>
                                                        <path fill="#c8b100" d="M272 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M272 211z"></path>
                                                        <path fill="#c8b100" d="M283 209"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M283 209">
                                                        </path>
                                                        <path fill="#c8b100" d="M285 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M285 211">
                                                        </path>
                                                        <path fill="#c8b100" d="M281 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M281 211">
                                                        </path>
                                                        <path fill="#c8b100" d="M286 211"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M286 211">
                                                        </path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M263 317h30v2h-30v-2z"></path>
                                                        <path fill="#ccc" d="M263 320h30v2h-30v-2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M263 320h30v2h-30v-2"></path>
                                                        <path fill="#005bbf" d="M263 322h30v2h-30v-2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M263 322h30v2h-30v-2"></path>
                                                        <path fill="#ccc" d="M263 327h30v-2h-30v2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M263 327h30v-2h-30v2"></path>
                                                        <path fill="#005bbf" d="M263 329h30v-2h-30v2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M263 329h30v-2h-30v2z"></path>
                                                        <path fill="#c8b100"
                                                            d="M286 308a3 3 0 0 0 3 3h-22a3 3 0 0 0 3-3h17"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M286 308a3 3 0 0 0 3 3h-22a3 3 0 0 0 3-3h17z"
                                                            stroke-linejoin="round"></path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M267 317h22v-6h-22z"></path>
                                                        <path fill="#ad1519"
                                                            d="M291 287l3 3-2 2c-2 1-2 3-2 4a6 6 0 0 1 0-9"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M291 287l3 3-2 2c-2 1-2 3-2 4a6 6 0 0 1 0-9z"></path>
                                                        <path fill="#ccc" d="M270 306h16v-77h-16z"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M281 229v76m2-76v76m-13 0h16v-76h-16z"></path>
                                                        <path fill="#ad1519"
                                                            d="M254 258l16-3h7c9 2 16 5 16 8l4-8c1-3-7-8-18-9h-9l-16 2v9">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M254 258l16-3h7c9 2 16 5 16 8l4-8c1-3-7-8-18-9h-9l-16 2v9"
                                                            stroke-linejoin="round"></path>
                                                        <path fill="#ad1519" d="M286 267c4 0 7-1 8-3s-1-3-4-4h-4v7">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M286 267c4 0 7-1 8-3s-1-3-4-4h-4v7"></path>
                                                        <path fill="#ad1519" d="M270 261l-6 2c0 1 2 3 6 5v-8"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M270 261l-6 2c0 1 2 3 6 5v-8"></path>
                                                        <path fill="#ad1519"
                                                            d="M295 282c0-1-4-4-10-6l-8-3c-8-4-14-8-14-9s-1 8-1 8 5 6 12 9l10 4c4 2 9 4 8 5v-8">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M295 282c0-1-4-4-10-6l-8-3c-8-4-14-8-14-9s-1 8-1 8 5 6 12 9l10 4c4 2 9 4 8 5v-8z"
                                                            stroke-linejoin="round"></path>
                                                        <path fill="#c8b100"
                                                            d="M264 254l2-7h-1v5l-3-4h-2l4 6h1m6-7h-2v6h2v-6m7 1h-2v6h2v-6m2 6h2v-3h1v2h2v-3h-3v6m3-5h-1v-2m8 7v2h2v-7h-1l-6 4h5zm-2-2h2v2h-2">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".048"
                                                            d="M182 192a2 2 0 1 1 2 2 2 2 0 0 1-2-2z"></path>
                                                        <path fill="#ad1519" stroke="#000" stroke-width=".25"
                                                            d="M206 175l16 2 8 2h7l10 2 7 5h-2v4l-4 5-2 2-5 4h-2v2l-32-4-32 4v-2h-2l-5-4-2-2-4-5v-4h-2l7-5 10-2h7l8-2 15-2z">
                                                        </path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".37400001"
                                                            d="M206 217c-12 0-22-1-30-4 8-2 18-4 30-4s22 1 30 4c-8 2-18 4-30 4">
                                                        </path>
                                                        <path fill="#ad1519"
                                                            d="M206 216a114 114 0 0 1-28-3 114 114 0 0 1 28-3 115 115 0 0 1 28 3 115 115 0 0 1-28 3">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".086"
                                                            d="M207 216v-6"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".134"
                                                            d="M205 216v-6"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".17299999"
                                                            d="M204 216v-6"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".221"
                                                            d="M202 216v-6"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".26899999"
                                                            d="M201 216v-6"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".317"
                                                            d="M198 215v-6m1 6v-6"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".35499999"
                                                            d="M195 215v-5m1 5v-6"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".403"
                                                            d="M192 215v-5m1 5v-5m1 5v-5"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".442"
                                                            d="M191 215v-4"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".49000001"
                                                            d="M190 214v-4"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".53799999"
                                                            d="M188 214v-4"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".57599998"
                                                            d="M186 214v-3m1 3v-3"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".60500002"
                                                            d="M185 214v-3"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".653"
                                                            d="M184 214v-2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".70099998"
                                                            d="M182 213v-2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".73900002"
                                                            d="M181 213"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".87400001"
                                                            d="M180 213"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".048"
                                                            d="M214 215v-6m-3 6v-6m-2 6v-6"></path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".37400001"
                                                            d="M206 207c-12 0-23 2-30 4s1-1 0-3-2-2-2-2 20-4 33-4 25 2 33 4-1 0-2 2-1 3 0 3-18-4-30-4">
                                                        </path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".37400001"
                                                            d="M206 202c-13 0-24 2-33 4h-1c8-3 20-4 33-4s25 2 33 4h-1c-8-2-20-4-33-4">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M206 216a114 114 0 0 1-28-3 114 114 0 0 1 28-3 115 115 0 0 1 28 3 115 115 0 0 1-28 3z"
                                                            stroke-linejoin="round"></path>
                                                        <path fill="#fff" stroke="#000" stroke-width=".37400001"
                                                            d="M197 205"></path>
                                                        <path fill="#ad1519" stroke="#000" stroke-width=".37400001"
                                                            d="M206 206"></path>
                                                        <path fill="#058e6e" stroke="#000" stroke-width=".37400001"
                                                            d="M190 206"></path>
                                                        <path fill="#fff" stroke="#000" stroke-width=".37400001"
                                                            d="M181 207"></path>
                                                        <path fill="#ad1519" stroke="#000" stroke-width=".37400001"
                                                            d="M174 208v-2h3l-3 2h-2"></path>
                                                        <path fill="#058e6e" stroke="#000" stroke-width=".37400001"
                                                            d="M222 206"></path>
                                                        <path fill="#fff" stroke="#000" stroke-width=".37400001"
                                                            d="M229 207"></path>
                                                        <path fill="#ad1519" stroke="#000" stroke-width=".37400001"
                                                            d="M238 208v-2h-3l3 2h2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M177 213c7-2 18-3 29-3s21 1 29 3"></path>
                                                        <path fill="#c8b100"
                                                            d="M182 184h1l2-3a7 7 0 0 1-4-6c0-4 5-8 12-8l8 2v-2l-9-2c-7 0-13 4-13 9a9 9 0 0 0 3 7v2">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M182 184h1l2-3a7 7 0 0 1-4-6c0-4 5-8 12-8l8 2v-2l-9-2c-7 0-13 4-13 9a9 9 0 0 0 3 7v2">
                                                        </path>
                                                        <path fill="#c8b100"
                                                            d="M182 184a9 9 0 0 1-4-7c0-3 2-6 5-8a8 8 0 0 0-3 6 9 9 0 0 0 3 7v2">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M182 184a9 9 0 0 1-4-7c0-3 2-6 5-8a8 8 0 0 0-3 6 9 9 0 0 0 3 7v2">
                                                        </path>
                                                        <path fill="#c8b100"
                                                            d="M160 187a9 9 0 0 1-2-6 9 9 0 0 1 1-4c2-4 8-7 16-7-7 0-13 3-15 6a7 7 0 0 0-1 3 7 7 0 0 0 3 6l-3 4h-1l2-3">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M160 187a9 9 0 0 1-2-6 9 9 0 0 1 1-4c2-4 8-7 16-7-7 0-13 3-15 6a7 7 0 0 0-1 3 7 7 0 0 0 3 6l-3 4h-1l2-3z">
                                                        </path>
                                                        <path fill="#c8b100"
                                                            d="M163 173l-4 4a9 9 0 0 0-1 4 9 9 0 0 0 2 6l-2 2a10 10 0 0 1-2-6c0-4 3-8 6-10">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M163 173l-4 4a9 9 0 0 0-1 4 9 9 0 0 0 2 6l-2 2a10 10 0 0 1-2-6c0-4 3-8 6-10z">
                                                        </path>
                                                        <path fill="#c8b100"
                                                            d="M206 164a4 4 0 0 1 3 3 30 30 0 0 1 0 4 26 26 0 0 0 1 8l-5 5-5-5a27 27 0 0 0 1-8 30 30 0 0 1 0-4 4 4 0 0 1 4-3">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M206 164a4 4 0 0 1 3 3 30 30 0 0 1 0 4 26 26 0 0 0 1 8l-5 5-5-5a27 27 0 0 0 1-8 30 30 0 0 1 0-4 4 4 0 0 1 4-3z">
                                                        </path>
                                                        <path fill="#c8b100"
                                                            d="M206 166h2a29 29 0 0 1 0 4 25 25 0 0 0 1 8l-3 3-3-3a25 25 0 0 0 1-8 28 28 0 0 1 0-4h2">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M206 166h2a29 29 0 0 1 0 4 25 25 0 0 0 1 8l-3 3-3-3a25 25 0 0 0 1-8 28 28 0 0 1 0-4h2z">
                                                        </path>
                                                        <path fill="#c8b100"
                                                            d="M230 184h-1l-2-3a7 7 0 0 0 4-6c0-4-5-8-12-8l-8 2v-2l9-2c7 0 13 4 13 9a9 9 0 0 1-3 7v2">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M230 184h-1l-2-3a7 7 0 0 0 4-6c0-4-5-8-12-8l-8 2v-2l9-2c7 0 13 4 13 9a9 9 0 0 1-3 7v2">
                                                        </path>
                                                        <path fill="#c8b100"
                                                            d="M230 184a9 9 0 0 0 4-7c0-3-2-6-5-8a9 9 0 0 1 3 6 9 9 0 0 1-3 7v2">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M230 184a9 9 0 0 0 4-7c0-3-2-6-5-8a9 9 0 0 1 3 6 9 9 0 0 1-3 7v2">
                                                        </path>
                                                        <path fill="#c8b100"
                                                            d="M252 187a9 9 0 0 0 2-6 9 9 0 0 0-1-4c-2-4-8-7-16-7 7 0 13 3 15 6a7 7 0 0 1 1 3 7 7 0 0 1-3 6l3 4h1l-2-3">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M252 187a9 9 0 0 0 2-6 9 9 0 0 0-1-4c-2-4-8-7-16-7 7 0 13 3 15 6a7 7 0 0 1 1 3 7 7 0 0 1-3 6l3 4h1l-2-3z">
                                                        </path>
                                                        <path fill="#c8b100"
                                                            d="M249 173l4 4a9 9 0 0 1 1 4 9 9 0 0 1-2 6l2 2a10 10 0 0 0 2-6c0-4-3-8-6-10">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M249 173l4 4a9 9 0 0 1 1 4 9 9 0 0 1-2 6l2 2a10 10 0 0 0 2-6c0-4-3-8-6-10z">
                                                        </path>
                                                        <path fill="#fff" d="M204 181l2-2 2 2-2 2-2-2"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M204 181l2-2 2 2-2 2-2-2z"></path>
                                                        <path fill="#fff" stroke="#000" stroke-width=".37400001"
                                                            d="M204 178l2-2 2 2-2 2-2-2m0-10"></path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".37400001"
                                                            d="M206 192h1v2a5 5 0 0 0 5 4 5 5 0 0 0 4-3v-2 2a5 5 0 0 0 9-1h1v4a4 4 0 0 0 5 4l4-2h1c0 1 1 3 2 3l4-2 3-3v2l-4 4h-4a4 4 0 0 1-3-3h-3a7 7 0 0 1-6-4l-5 2-5-2-5 2a7 7 0 0 1-6-3 7 7 0 0 1-6 3l-5-2-5 2-5-2a7 7 0 0 1-6 4h-3a4 4 0 0 1-3 3h-4l-4-4v-2l3 3 4 2c1 0 2-2 2-3h1l4 2a4 4 0 0 0 5-4v-4h1a5 5 0 0 0 9 1v-2 2a5 5 0 0 0 4 3 5 5 0 0 0 5-4v-2h1">
                                                        </path>
                                                        <path fill="#fff" stroke="#000" stroke-width=".37400001"
                                                            d="M239 198c0-1 0-2-1-2h-2c0 1 0 2 1 2h2m-21-4c0-1 0-2-1-2h-1c0 1 0 2 1 2h1m-24 0c0-1 0-2 1-2h1c0 1 0 2-1 2h-1m-21 4c0-1 0-2 1-2h2c0 1 0 2-1 2h-2">
                                                        </path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".37400001"
                                                            d="M183 184l2 3h1v4h-4v-2h1a5 5 0 0 1 1-3M183 194h-5l-3 2h8m3 0h7l-3 2h-4">
                                                        </path>
                                                        <path fill="#ad1519" stroke="#000" stroke-width=".37400001"
                                                            d="M182 192a2 2 0 1 1 2 2 2 2 0 0 1-2-2"></path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".37400001"
                                                            d="M206 181a6 6 0 0 1 2 4h2v4h-3v-4h2a6 6 0 0 1 2-4M205 192h-5l-4 2 4 2h5m3 0h5l4 2-4 2h-5m22-8l-2 3h-1v4h4v-2h-1a5 5 0 0 0-1-3">
                                                        </path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".37400001"
                                                            d="M229 194h5l3 2h-8m-3 0h-7l3 2h4"></path>
                                                        <path fill="#ad1519" stroke="#000" stroke-width=".37400001"
                                                            d="M226 192a2 2 0 1 1 2 2 2 2 0 0 1-2-2m23 4h-2c-1 1-1 2 0 2h2c1-1 1-2 0-2">
                                                        </path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".37400001"
                                                            d="M246 198h3l2-3h3a3 3 0 0 0-3-3h-3l-2 2a7 7 0 0 0 0 4v-2l-2-2h-1a5 5 0 0 0 0 1h-4l3 2h4m-80 0h-3l-2-3h-3a3 3 0 0 1 3-3h3l2 2a7 7 0 0 1 0 4v-2l2-2h1a5 5 0 0 1 0 1h4l-3 2h-4">
                                                        </path>
                                                        <path fill="#ad1519" stroke="#000" stroke-width=".37400001"
                                                            d="M163 197h2c1 1 1 2 0 2h-2c-1-1-1-2 0-2m41-6a2 2 0 1 1 2 2 2 2 0 0 1-2-2">
                                                        </path>
                                                        <path fill="#005bbf" stroke="#000" stroke-width=".25"
                                                            d="M202 161a4 4 0 1 1 4 4 4 4 0 0 1-4-4"></path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".25"
                                                            d="M205 149v2h-2v2h2v6h-3v2h8v-2h-3v-6h2v-2h-2v-2h-2z">
                                                        </path>
                                                        <path fill="#ccc"
                                                            d="M206 331a82 82 0 0 1-35-8 23 23 0 0 1-13-20v-33h96v32a23 23 0 0 1-13 20 81 81 0 0 1-35 8">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".49900001"
                                                            d="M206 331a82 82 0 0 1-35-8 23 23 0 0 1-13-20v-33h96v32a23 23 0 0 1-13 20 81 81 0 0 1-35 8z">
                                                        </path>
                                                        <path fill="#ccc" d="M206 270h48v-53h-48z"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".49900001"
                                                            d="M206 270h48v-53h-48z"></path>
                                                        <path fill="#ad1519"
                                                            d="M206 302c0 13-11 23-24 23s-24-10-24-23v-32h48v32"></path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".49900001"
                                                            d="M169 321l6 3v-55h-6v52z"></path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".47999999"
                                                            d="M158 302a24 24 0 0 0 6 15v-48h-5v32z"
                                                            stroke-linejoin="round"></path>
                                                        <path fill="#c7b500" stroke="#000" stroke-width=".49900001"
                                                            d="M179 325h6v-56h-6z"></path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".49900001"
                                                            d="M190 324l6-3v-52h-6v55z"></path>
                                                        <path fill="#ad1519" d="M158 270h48v-53h-48z"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".49900001"
                                                            d="M158 270h48v-53h-48z"></path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".49900001"
                                                            d="M201 316c2-2 5-7 5-12v-35h-6v47z"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".49900001"
                                                            d="M206 302c0 13-11 23-24 23s-24-10-24-23v-32h48v32"></path>
                                                        <path fill="#ad1519"
                                                            d="M255 270v32c0 13-11 23-24 23s-24-10-24-23v-32h48"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".49900001"
                                                            d="M255 270v32c0 13-11 23-24 23s-24-10-24-23v-32h48"></path>
                                                        <path fill="#c8b100"
                                                            d="M215 294h-4a3 3 0 0 0 2 2v4h2v-4l2-2h-1m22 0h-4l5 5h-1l-5-5v9h-2v-9l-5 5h-1l5-5h9zm3 0h4l2 2v4h2v-4a3 3 0 0 0 2-2h-12m-7 22l-3 2-3-2h2v-7h2v7h2zm-11-2h-1l-4-3h-2a2 2 0 0 1 0-3 15 15 0 0 1-1-5h2v4h1l4-5h1l-4 5a2 2 0 0 1 0 3l3 3zm-6-5h2a1 1 0 0 1 0 2h-2a1 1 0 0 1 0-1zm-2-4h-2v-4h2v5zm1-5h2v4h-2a14 14 0 0 1 0-3v-3zm6 14l5 3v-2l-4-2h-1m-1 1l5 3h-1l-4-2v-2m2-9h2l3-3h-1l-4 4m-1-1h-1l3-3h2l-4 4m18 10h1l4-3h2a2 2 0 0 0 0-3 15 15 0 0 0 1-5h-2v4h-1l-4-5h-1l4 5a2 2 0 0 0 0 3l-3 3zm6-5h-2a1 1 0 0 0 0 1h2a1 1 0 0 0 0-1zm2-4h2v-4h-2v5zm-1-5h-2v4h2a14 14 0 0 0 0-3v-3m-6 14l-5 3v-2l4-2h1m1 1l-5 3h1l4-2v-2m-2-9h-2l-3-3h1l4 4m1-1h1l-3-3h-2l4 4m-20-9v2h5v-2h-6m21 0v2h-5v-2h6m-12 22zm2-8h2v-4h-2v5m-2 0h-2v-4h2v5M212 294l2-2v-5h2v5l2 2h-5m12 0h4l-5-6h1l5 6v-7h2v7l5-6h1l-5 6h-9zm22 0h4l-2-2v-5h-2v5l-2 2h2m-30-15l6 7h1l-6-7h5v-2h-4l-3-2a3 3 0 0 0-3 2 3 3 0 0 0 2 2v5h2v-5zm32 0v5h-2v-5l-6 7h-1l6-7h-5v-2h4l2-2a3 3 0 0 1 3 2 3 3 0 0 1-2 2zm-16 0v3h-2v-3l-2-2h-4v-2h4l2-2 2 2h4v2h-4l-2 2zm-18 4h-2v4h2v-5m2 0h2v4h-2v-5m31 0h-2v4h2v-5m2 0h2v4h-2v-5m-26 1h2l3 3h-1l-4-4m-1 1h-1l3 3h2l-4-4m18-1h-2l-3 3h1l4-4m1 1h1l-3 3h-2l4-4m-20 9v-2h5v2h-6m-7-17zm12 1v2h-5v-2h6m0-2v-2h-5v2h6m16 18v-2h-5v2h6m4-17zm-16 0zm6 1v2h5v-2h-6m0-2v-2h5v2h-6m-6 5h-2v4h2v-5m2 0h2v4h-2v-5">
                                                        </path>
                                                        <path fill="none" stroke="#c8b100" stroke-width=".25"
                                                            d="M233 316l-3 2-3-2h2v-7h2v7h2zm-5-20h-4v-2h4l-5-6h1l5 6v-7h2v7l5-6h1l-5 5h4v2h-4l5 5h-1l-5-5v9h-2v-9l-5 5h-1l5-5m-13-17l6 7h1l-6-7h5v-2h-4l-3-2a3 3 0 0 0-3 2 2 2 0 0 0 2 2v5h2v-5zm7 35h-1l-4-3h-2a2 2 0 0 1 0-3 15 15 0 0 1-1-5h2v4h1l4-5h1l-4 5a2 2 0 0 1 0 3l3 3zm-8-13v-4a3 3 0 0 1-2-2 3 3 0 0 1 2-2v-5h2v5l2 2h4v2h-4l-2 2v4h-2m2 8h2a1 1 0 0 1 0 2h-2a1 1 0 0 1 0-1zm-2-4h-2v-4h2v5zm1-5h2v4h-2a14 14 0 0 1 0-3v-3zm6 14l5 3v-2l-4-2h-1m-1 1l5 3h-1l-4-2v-2">
                                                        </path>
                                                        <path fill="none" stroke="#c8b100" stroke-width=".25"
                                                            d="M222 305h2l3-3h-1l-4 4m-1-1h-1l3-3h2l-4 4m-8-9zm26 19h1l4-3h2a2 2 0 0 0 0-3 15 15 0 0 0 1-5h-2v4h-1l-4-5h-1l4 5a2 2 0 0 0 0 3l-3 3zm8-13v-4a3 3 0 0 0 2-2 3 3 0 0 0-2-2v-5h-2v5l-2 2h-4v2h4l2 2v4h2zm-2 8h-2a1 1 0 0 0 0 1h2a1 1 0 0 0 0-1zm2-4h2v-4h-2v5zm-1-5h-2v4h2a14 14 0 0 0 0-3v-3m2-20v5h-2v-5l-6 7h-1l6-7h-5v-2h4l2-2a3 3 0 0 1 3 2 2 2 0 0 1-2 2zm-16 0v3h-2v-3l-2-2h-4v-2h4l2-2 2 2h4v2h-4zm9 34l-5 3v-2l4-2h1m1 1l-5 3h1l4-2v-2m-27-31h-2v4h2v-5m2 0h2v4h-2v-5m31 0h-2v4h2v-5">
                                                        </path>
                                                        <path fill="none" stroke="#c8b100" stroke-width=".25"
                                                            d="M247 283h2v4h-2v-5m-9 22h-2l-3-3h1l4 4m1-1h1l-3-3h-2l4 4m-18-20h2l3 3h-1l-4-4m-1 1h-1l3 3h2l-4-4m18-1h-2l-3 3h1l4-4m1 1h1l-3 3h-2l4-4m-20 9v-2h5v2h-6m0 2v2h5v-2h-6m-7-19zm12 1v2h-5v-2h6m0-2v-2h-5v2h6m20 19zm-4-1v-2h-5v2h6m0 2v2h-5v-2h6m-12 22zm2-8h2v-4h-2v5m-2 0h-2v-4h2v5m16-33zm-16 0zm6 1v2h5v-2h-6m0-2v-2h5v2h-6m-6 5h-2v4h2v-5m2 0h2v4h-2v-5">
                                                        </path>
                                                        <path fill="#058e6e" d="M228 295a3 3 0 1 1 3 2 3 3 0 0 1-3-2">
                                                        </path>
                                                        <path fill="#db4446" d="M231 230"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M231 230z"></path>
                                                        <path fill="#ed72aa" stroke="#000" stroke-width=".37400001"
                                                            d="M238 228v2h1a5 5 0 0 1 0 1h-1v2h-2v4h-1a10 10 0 0 0 2 5c1 1 2 4 5 3s2-5 1-7a17 17 0 0 1-1-5v-3a8 8 0 0 1 0-3v-2h1a7 7 0 0 1 0 1v-2h2a6 6 0 0 1-1 3l-2 2h2v4l-2 2c-1 1 0 4 0 5l2 6c0 1 0 3-2 5h-3a3 3 0 0 0-1 3 2 2 0 0 0 1 2h2v4a3 3 0 0 0 0 1s1 1 0 1h-5v-1h2a1 1 0 0 0 0-1h-1a8 8 0 0 1 0 1 4 4 0 0 0 0 1h-4a4 4 0 0 1 0-2h-2a4 4 0 0 0 0 3v2h-8v-1h-2c0-1-1-1 0-1h1s-1 0 0-1h1c1 0 0 1 1 1h2a2 2 0 0 1 0-1v-2l2-2h5l-3-2-2-2v-2h-3v2h-4v1h-3v-1h-2s-1-1 0-1h2v-1h2a2 2 0 0 0 0 1h12c0-1 0-2-1-2h-2v-1h5l3 2 2 2">
                                                        </path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M217 227v1h-1z"></path>
                                                        <path fill="#db4446" d="M215 228"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M215 228z"></path>
                                                        <path fill="#db4446" d="M214 231h-1a2 2 0 0 0 0 1h1"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M214 231h-1a2 2 0 0 0 0 1h1z"></path>
                                                        <path d="M228 231"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M228 231">
                                                        </path>
                                                        <path d="M229 231"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M229 231">
                                                        </path>
                                                        <path d="M229 227"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M229 227">
                                                        </path>
                                                        <path d="M230 228"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M230 228">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M224 234h2v2h4a4 4 0 0 0 0 1v2h2v2h2m-11 1h3m1 5h2">
                                                        </path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M217 246zm16 1s2 1 2 2v2"></path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M224 258v1h1a1 1 0 0 1 0-1h-1z"></path>
                                                        <path fill="#db4446" d="M236 259a3 3 0 0 0 0-1"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M236 259a3 3 0 0 0 0-1z"></path>
                                                        <path fill="#db4446" d="M236 262s-1 1 0 1"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M236 262s-1 1 0 1z"></path>
                                                        <path fill="#db4446" d="M239 263a1 1 0 0 0 0 1"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M239 263a1 1 0 0 0 0 1z"></path>
                                                        <path fill="#ffd691" stroke="#000" stroke-width=".49900001"
                                                            d="M209 316a4 4 0 0 1 3 4c0 2-2 4-5 4s-5-2-5-4 1-4 3-4h4">
                                                        </path>
                                                        <path fill="#058e6e" stroke="#000" stroke-width=".49900001"
                                                            d="M206 327l-5-3h-4l3 2h6m1 0s2-3 5-3h5l-4 2h-6"></path>
                                                        <path fill="#ad1519" stroke="#000" stroke-width=".49900001"
                                                            d="M207 324a5 5 0 0 1 0-7 5 5 0 0 1 0 7"></path>
                                                        <path fill="#058e6e" stroke="#000" stroke-width=".49900001"
                                                            d="M206 329a10 10 0 0 0 1-3 10 10 0 0 0 0-2h1v4h-1"></path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".37400001"
                                                            d="M201 165z"></path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".442"
                                                            d="M175 229h-2v4h2v2h-3v7h2v14h-4v7h27v-7h-4v-15h2v-7h-3v-2h2v-4h-7v4h2v2h-3v-8h2v-4h-7v4h2v8h-3v-2h2v-4h-4zm-6 34h27m-27-2h27m-27-2h27m-27-2h27m-27-2h27m-24-2h20m-20-2h20m-20-2h20m-20-2h20m-20-2h20m-20-2h20m-20-2h20m-22-2h24m-24-2h24m-24-2h24m-24-2h24m-20-2h17m-10-2h3m-3-2h3m-3-2h3m-3-2h3m-5-2h7m-12 8h4m-5-2h7m-7 33v-2m0-2v-2m-2 2v2m3 0v-2m2 4v-2m0-2v-2m0-2v-2m0-2v-2m-2 7v-2m-3 2v-2m7 0v2m2-2v-2m-5-2v2m4-2v2m3-2v2m-2-2v-2m2-2v2m0-5v2m-2-4v2m2-4v2m-3-2v2m-4-2v2m-2-4v2m3-2v2m3-2v2m2-4v2m-3-2v2m-4-2v2m-2-4v2m7-2v2m-3-5v2m15-2h-4m5-2h-7m7 33v-2m0-2v-2m2 2v2m-3 0v-2m-2 4v-2m0-2v-2m0-2v-2m0-2v-2m2 7v-2m3 2v-2m-7 0v2m-2-2v-2m5-2v2m-4-2v2m-3-2v2m2-2v-2m-2-2v2m0-5v2m2-4v2m-2-4v2m3-2v2m4-2v2m2-4v2m-3-2v2m-3-2v2m-2-4v2m3-2v2m4-2v2m2-4v2m-7-2v2m3-5v2m-7 18v-2m0-5v-2m0 5v-2m0-5v-2m0-2v-2m0-4v-2m0-2v-2m-8 5h4m3-5h3m3 5h4">
                                                        </path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".442"
                                                            d="M187 263v-5c0-1 0-4-5-4s-4 3-4 4v5h9z"></path>
                                                        <path fill="#c8b100" stroke="#000" stroke-width=".442"
                                                            d="M179 258h-2c0-1 0-2 1-3l2 2h-1zm6 0h2c0-1 0-2-1-3l-2 2h1zm-2-2v-2h-4v2h2zm-4-6v-5a2 2 0 1 0-5 0v5zm7 0v-5a2 2 0 1 1 5 0v5zm-2-12v-4h-4v4h4zm3 0v-4h4v4h-4zm-10 0v-4h-4v4z">
                                                        </path>
                                                        <path fill="#0039f0"
                                                            d="M185 263v-4a3 3 0 0 0-3-3 3 3 0 0 0-3 3v4h6zm-7-13v-4a2 2 0 1 0-4 0v4h4zm8 0v-4a2 2 0 1 1 4 0v4h-4z">
                                                        </path>
                                                        <path fill="#ad1519"
                                                            d="M191 270c0-10 7-18 16-18s16 8 16 18-7 18-16 18-16-8-16-18">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".58600003"
                                                            d="M191 270c0-10 7-18 16-18s16 8 16 18-7 18-16 18-16-9-16-18z">
                                                        </path>
                                                        <path fill="#005bbf"
                                                            d="M195 270c0-7 5-13 11-13s11 6 11 13-5 13-11 13-11-6-11-13">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".58600003"
                                                            d="M195 270c0-7 5-13 11-13s11 6 11 13-5 13-11 13-11-6-11-13z">
                                                        </path>
                                                        <path fill="#c8b100"
                                                            d="M201 261a5 5 0 0 0-1 3 6 6 0 0 0 1 2v2h4v-2a6 6 0 0 0 1-2 5 5 0 0 0-1-3">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".32600001"
                                                            d="M201 261a5 5 0 0 0-1 3 6 6 0 0 0 1 2v2h4v-2a6 6 0 0 0 1-2 5 5 0 0 0-1-3z"
                                                            stroke-linejoin="round"></path>
                                                        <path fill="#c8b100" d="M199 270z"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".32600001"
                                                            d="M199 270z"></path>
                                                        <path fill="#c8b100"
                                                            d="M211 261a5 5 0 0 0-1 3 6 6 0 0 0 1 2v2h4v-2a6 6 0 0 0 1-2 5 5 0 0 0-1-3">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".32600001"
                                                            d="M211 261a5 5 0 0 0-1 3 6 6 0 0 0 1 2v2h4v-2a6 6 0 0 0 1-2 5 5 0 0 0-1-3z"
                                                            stroke-linejoin="round"></path>
                                                        <path fill="#c8b100" d="M209 270z"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".32600001"
                                                            d="M209 270z"></path>
                                                        <path fill="#c8b100"
                                                            d="M206 270a5 5 0 0 0-1 3 6 6 0 0 0 1 2v2h4v-2a6 6 0 0 0 1-2 5 5 0 0 0-1-3">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".32600001"
                                                            d="M206 270a5 5 0 0 0-1 3 6 6 0 0 0 1 2v2h4v-2a6 6 0 0 0 1-2 5 5 0 0 0-1-3z"
                                                            stroke-linejoin="round"></path>
                                                        <path fill="#c8b100" d="M204 279z"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".32600001"
                                                            d="M204 279z"></path>
                                                        <path fill="#c8b100"
                                                            d="M238 223h-2a1 1 0 0 1 0-1h-1c-1 0-1-1-1-1a4 4 0 0 1 0 1l3 2 2 2h1v-1h-2a1 1 0 0 1 0-1">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M238 223h-2a1 1 0 0 1 0-1h-1c-1 0-1-1-1-1a4 4 0 0 1 0 1l3 2 2 2h1v-1h-2a1 1 0 0 1 0-1z">
                                                        </path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M236 221">
                                                        </path>
                                                        <path fill="#c8b100" d="M235 222"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M235 222">
                                                        </path>
                                                        <path fill="#c8b100" d="M236 223"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M236 223">
                                                        </path>
                                                        <path fill="#c8b100" d="M235 222"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M235 222z"></path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M234 221">
                                                        </path>
                                                        <path fill="#c8b100" d="M233 221"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M233 221z"></path>
                                                        <path fill="#c8b100" d="M238 223"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M238 223">
                                                        </path>
                                                        <path fill="#c8b100" d="M237 223"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M237 223">
                                                        </path>
                                                        <path fill="#c8b100" d="M238 224"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M238 224">
                                                        </path>
                                                        <path fill="#c8b100" d="M237 223"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25"
                                                            d="M237 223z"></path>
                                                        <path fill="#c8b100" d="M240 224"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M240 224">
                                                        </path>
                                                        <path fill="#c8b100" d="M240 226"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M240 226">
                                                        </path>
                                                        <path fill="#c8b100" d="M239 224"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".25" d="M239 224">
                                                        </path>
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".28799999"
                                                            d="M279 205"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".019"
                                                            d="M134 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".029"
                                                            d="M134 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".038"
                                                            d="M134 218"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".048"
                                                            d="M133 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".058"
                                                            d="M133 218"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".067"
                                                            d="M132 218"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".077"
                                                            d="M132 219"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".086"
                                                            d="M131 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".096"
                                                            d="M131 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".106"
                                                            d="M131 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".115"
                                                            d="M130 219"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".125"
                                                            d="M130 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".134"
                                                            d="M130 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".14399999"
                                                            d="M129 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".17299999"
                                                            d="M129 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".01" d="M135 219">
                                                        </path>
                                                        <path fill="none" stroke="#000" stroke-width=".019"
                                                            d="M278 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".029"
                                                        ...
                                                        <path fill="none" stroke="#000" stroke-width=".17299999"
                                                            d="M273 217"></path>
                                                        <path fill="none" stroke="#000" stroke-width=".01" d="M278 219">
                                                        </path>
                                                    </svg>
                                                    <div class="country">España</div>
                                                </label>
                                                <label class="countryListItem" data-country-native="Eesti"
                                                    data-country-english="Estonia">
                                                ...
                                                <label class="countryListItem" data-country-native="Suomi"
                                                    data-country-english="Finland">
                                                ...
                                                <label class="countryListItem" data-country-native="France"
                                                    data-country-english="France">
                                                ...
                                                <label class="countryListItem" data-country-native="United Kingdom"
                                                    data-country-english="United Kingdom">
                                                    <input type="radio" class="radio" name="country" value="GBR">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480"
                                                        class="languageFlag">
                                                        <path fill="#006" d="M0 0h640v480H0z"></path>
                                                        <path fill="#fff"
                                                            d="M427 240l213-106V26L320 186l107 54m-107 54l320 160V346L427 240l-107 54m-107-54L0 346v108l320-160-107-54m107-54L0 26v108l213 106 107-54">
                                                        </path>
                                                        <path fill="#fff"
                                                            d="M240 160h160v160H240zm0 320h160v.01H240zm0-160h160v159.99H240zm160-160h240v160H400zM240 0h160v160H240zM0 160h240v160H0z">
                                                        </path>
                                                        <path fill="#c00"
                                                            d="M272 192h96v96h-96zm0 288h96v.01h-96zm96-288h272v96H368zM160 320L0 400v36l232-116h-72m112-32h96v191.99h-96zm208-128l160-80V44L408 160h72m0 160l160 80v-36l-88-44h-72M272 0h96v192h-96zM0 192h272v96H0zm160-32L0 80v36l88 44h72">
                                                        </path>
                                                    </svg>
                                                    <div class="country">United Kingdom</div>
                                                </label>
                                                <label class="countryListItem" data-country-native="Hrvatska"
                                                    data-country-english="Croatia">
                                                ...
                                                <label class="countryListItem" data-country-native="Indonesia"
                                                    data-country-english="Indonesia">
                                                ...
                                                <label class="countryListItem" data-country-native="India"
                                                    data-country-english="India">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480"
                                                        ...
                                                        <path d="M306.41 290.71l9.89-30 2.15-14.95-5.62 14z"
                                                            fill="#008"></path>
                                                        <path
                                                            d="M293.75 285.47l17.31-26.38L317 245.2l-9.06 12.09zM282.88 277.12l23.54-21 9.34-11.88-11.88 9.34z"
                                                            fill="#008"></path>
                                                        <path
                                                            d="M274.53 266.25l28.18-14.19L314.8 243l-13.89 5.94zM269.29 253.59l30.89-6.42 14-5.62-14.95 2.15z"
                                                            fill="#008"></path>
                                                        <path
                                                            d="M267.5 240l31.5 1.8 15-1.8-15-1.8zM269.29 226.41l30 9.89 14.95 2.15-14-5.62z"
                                                            fill="#008"></path>
                                                        <path
                                                            d="M274.53 213.75l26.38 17.31L314.8 237l-12.09-9.06zM282.88 202.88l21 23.54 11.88 9.34-9.34-11.88z"
                                                            fill="#008"></path>
                                                        <path
                                                            d="M293.75 194.53l14.19 28.18L317 234.8l-5.94-13.89zM306.41 189.29l6.42 30.89 5.62 14-2.15-14.95z"
                                                            fill="#008"></path>
                                                        <path
                                                            d="M320 187.5l-1.8 31.5 1.8 15 1.8-15zM333.59 189.29l-9.89 30-2.15 14.95 5.62-14z"
                                                            fill="#008"></path>
                                                        <path
                                                            d="M346.25 194.53l-17.31 26.38L323 234.8l9.06-12.09zM357.12 202.88l-23.54 21-9.34 11.88 11.88-9.34z"
                                                            fill="#008"></path>
                                                        <path
                                                            d="M365.47 213.75l-28.18 14.19L325.2 237l13.89-5.94zM370.71 226.41l-30.89 6.42-14 5.62 14.95-2.15z"
                                                            fill="#008"></path>
                                                        <path
                                                            d="M372.5 240l-31.5-1.8-15 1.8 15 1.8zM370.71 253.59l-30-9.89-14.95-2.15 14 5.62z"
                                                            fill="#008"></path>
                                                        <path
                                                            d="M365.47 266.25l-26.38-17.31L325.2 243l12.09 9.06zM357.12 277.12l-21-23.54-11.88-9.34 9.34 11.88z"
                                                            fill="#008"></path>
                                                        <path
                                                            d="M346.25 285.47l-14.19-28.18L323 245.2l5.94 13.89zM333.59 290.71l-6.42-30.89-5.62-14 2.15 14.95z"
                                                            fill="#008"></path>
                                                    </svg>
                                                    <div class="country">India</div>
                                                </label>
                                                <label class="countryListItem" data-country-native="Italia"
                                                    data-country-english="Italy">
                                                ...
                                                <label class="countryListItem" data-country-native="日本"
                                                    data-country-english="Japan">
                                                ...
                                                <label class="countryListItem" data-country-native="الكويت"
                                                    data-country-english="Kuwait">
                                                ...
                                                <label class="countryListItem" data-country-native="Lietuva"
                                                    data-country-english="Lithuania">
                                                ...
                                                <label class="countryListItem" data-country-native="Latvija"
                                                    data-country-english="Latvia">
                                                    <input type="radio" class="radio" name="country" value="LVA">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480"
                                                        class="languageFlag">
                                                        <path fill="#fff" d="M0 0h640v480H0z"></path>
                                                        <path fill="#ab231d" d="M0 0h640v192H0zm0 288h640v192H0z">
                                                        </path>
                                                    </svg>
                                                    <div class="country">Latvija</div>
                                                </label>
                                                <label class="countryListItem" data-country-native="México"
                                                    data-country-english="Mexico">
                                                ...
                                                <label class="countryListItem" data-country-native="Norge"
                                                    data-country-english="Norway">
                                                ...
                                                <label class="countryListItem" data-country-native="Polska"
                                                    data-country-english="Poland">
                                                ...
                                                <label class="countryListItem" data-country-native="Portugal"
                                                    data-country-english="Portugal">
                                                ...
                                                <label class="countryListItem" data-country-native="Россия"
                                                    data-country-english="Russia">
                                                ...
                                                <label class="countryListItem" data-country-native="السعودية"
                                                    data-country-english="Saudi Arabia">
                                                    <input type="radio" class="radio" name="country" value="SAU">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="640" height="480"
                                                        viewBox="0 0 640 480" class="languageFlag">
                                                        <style>
                                                            .sa0 {
                                                                fill: #199D00;
                                                            }
                                                ...
                                                <label class="countryListItem" data-country-native="Slovenská republika"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480"
                                                        ...
                                                        <path fill="#fff"
                                                            d="M233 371c-43-21-105-62-105-143s4-118 4-118h202s4 37 4 118-62 122-105 143z">
                                                        </path>
                                                        <path fill="#ee1c25"
                                                            d="M233 360c-39-19-96-57-96-131s4-109 4-109h184s4 34 4 109-57 112-96 131z">
                                                        </path>
                                                        <path fill="#fff"
                                                            d="M241 209c11 0 32 1 50-6v28c-17-6-38-6-50-6v41h-16v-39c-12 0-33 0-50 6v-28c19 6 39 6 50 6v-28c-10 0-24 0-40 6v-28c16 5 30 6 40 6-1-16-5-37-5-37h28s-5 21-5 37c10 0 24 0 40-6v28c-16-5-30-6-40-6v26z">
                                                        </path>
                                                        <path fill="#0b4ea2"
                                                            d="M233 263c-20 0-31 28-31 28a24 24 0 0 0-22-13c-11 0-19 10-24 19 20 32 52 51 77 63 25-12 57-32 77-63-5-9-13-19-24-19a24 24 0 0 0-22 13s-11-28-31-28z">
                                                        </path>
                                                    </svg>
                                                    <div class="country">Slovenská republika</div>
                                                </label>
                                                <label class="countryListItem" data-country-native="Slovenija"
                                                    data-country-english="Slovenia">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="640" height="480"
                                                        ...
                                                        <path
                                                            d="M219.093 93.141c-3.213 55.8-5.049 86.382-12.555 100.53-8.109 15.192-16.002 26.325-47.655 39.717-31.653-13.401-39.546-24.525-47.664-39.726-7.506-14.148-9.342-44.721-12.555-100.521l4.68-1.782c9.414-3.249 16.443-5.868 21.636-7.029 7.443-1.782 13.77-3.798 33.768-4.275 20.007.387 26.361 2.529 33.804 4.32 5.157 1.242 12.483 3.69 21.825 7.011l4.716 1.755z"
                                                            class="si0"></path>
                                                        <path
                                                            d="M214.485 91.314c-3.042 55.683-5.58 81.18-9.549 93.447-7.695 20.988-19.872 32.499-46.089 43.479-26.217-10.989-38.394-22.5-46.089-43.488-3.969-12.258-6.471-37.692-9.423-93.501 9.216-3.258 16.443-5.805 21.645-6.966 7.443-1.782 13.77-3.888 33.768-4.275 20.007.387 26.406 2.493 33.849 4.275 5.193 1.161 12.573 3.708 21.879 7.029h.009z"
                                                            class="si1"></path>
                                                        <path
                                                            d="M158.82 108.36l1.26 3.366 5.526.855-3.582 2.448 3.465 2.619-5.031.954-1.53 3.051-1.719-3.141-4.788-.765 3.258-2.673-3.357-2.439 5.301-.918 1.197-3.357z"
                                                            class="si3"></path>
                                                        <path
                                                            d="M203.037 171.558l-3.06-2.745-2.214-4.122-4.329-4.257-2.259-4.302-4.338-4.392-2.124-4.302-2.304-2.106-1.521-1.656-3.915 3.888-2.133 4.221-2.655 2.727-2.925-2.583-2.205-4.401-8.199-16.488-8.199 16.488-2.205 4.401-2.916 2.583-2.655-2.727-2.133-4.221-3.915-3.888-1.521 1.656-2.304 2.106-2.124 4.302-4.338 4.392-2.259 4.302-4.338 4.257-2.214 4.122-3.051 2.808c1.584 15.282 10.188 27.261 14.877 32.733 5.229 5.751 16.011 13.446 29.205 18.54 13.221-4.986 24.156-12.789 29.394-18.54 4.68-5.472 13.284-17.442 14.877-32.796z"
                                                            class="si2"></path>
                                                        <path
                                                            d="M172.005 84.915l1.26 3.366 5.526.855-3.582 2.448 3.465 2.619-5.031.954-1.53 3.051-1.719-3.141-4.788-.765 3.258-2.673-3.357-2.439 5.301-.918 1.197-3.357zm-26.361-.045l1.26 3.366 5.526.855-3.582 2.448 3.465 2.619-5.031.954-1.53 3.051-1.719-3.141-4.788-.765 3.258-2.673-3.357-2.439 5.301-.918 1.197-3.357z"
                                                            class="si3"></path>
                                                        <path
                                                            d="M196.197 192.753l-5.967.018-5.508-.468-6.669-3.708-7.524.054-6.516 3.6-5.139.513-5.139-.513-6.516-3.6-7.524-.054-6.669 3.708-5.508.468-6.048-.09-2.916-5.598.108-.126 8.928 1.674 5.508-.459 6.669-3.708 7.533.036 6.516 3.6 5.139.513 5.139-.513 6.516-3.6 7.524-.054 6.669 3.708 5.508.459 8.694-1.728.117.261-2.925 5.607zm-69.111 8.604l5.913-.468 6.669-3.708 7.524.054 6.516 3.6 5.139.513 5.139-.513 6.516-3.6 7.524-.054 6.669 3.708 5.985.468 3.861-5.391-.126-.126-4.14 1.368-5.508-.459-6.669-3.708-7.524.054-6.516 3.6-5.139.513-5.139-.513-6.516-3.6-7.524-.054-6.669 3.708-5.508.468-4.059-1.161-.045.225 3.627 5.076z"
                                                            class="si1"></path>
                                                    </svg>
                                                    <div class="country">Slovenija</div>
                                                </label>
                                                <label class="countryListItem" data-country-native="Sverige"
                                                    data-country-english="Sweden">
                                                    <input type="radio" class="radio" name="country" value="SWE">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480"
                                                        class="languageFlag">
                                                        <path fill="#006aa7" d="M0 288h177v192H0zM0 0h177v192H0z">
                                                        </path>
                                                        <path fill="#fecc00" d="M0 192h177v96H0z"></path>
                                                        <path fill="#fecc00" d="M176 0h96v480h-96z"></path>
                                                        <path fill="#fecc00" d="M269 192h371v96H269z"></path>
                                                        <path fill="#006aa7"
                                                            d="M272 288h368v192H272zm0-288h368v192H272z"></path>
                                                    </svg>
                                                    <div class="country">Sverige</div>
                                                </label>
                                                <label class="countryListItem" data-country-native="ประเทศไทย"
                                                    data-country-english="Thailand">
                                                ...
                                                <label class="countryListItem" data-country-native="Türkiye"
                                                    data-country-english="Turkey">
                                                    <input type="radio" class="radio" name="country" value="TUR">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480"
                                                        class="languageFlag">
                                                        <path fill="#f31930" d="M0 0h640v480H0z"></path>
                                                        <path fill="#fff"
                                                            d="M407 247c0 66-55 120-122 120s-122-53-122-120 55-120 122-120 122 54 122 120z">
                                                        </path>
                                                        <path fill="#f31830"
                                                            d="M413 247c0 53-44 96-98 96s-98-43-98-96 44-96 98-96 98 43 98 96z">
                                                        </path>
                                                        <path fill="#fff"
                                                            d="M431 191v44l-41 11 41 15v41l27-32 40 14-23-34 28-34-44 12-26-37z">
                                                        </path>
                                                    </svg>
                                                    <div class="country">Türkiye</div>
                                                </label>
                                                <label class="countryListItem" data-country-native="United States"
                                                    data-country-english="United States">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480"
                                                        ...
                                                        <path fill="#fff"
                                                            d="M27 11l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h9l-8 6 3 10-8-6-8 6 3-10-8-6h11zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zM55 37l3 10h9l-8 6 3 10-8-6-8 6 3-10-8-6h11zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zM27 63l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h9l-8 6 3 10-8-6-8 6 3-10-8-6h11zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zM55 89l3 10h9l-8 6 3 10-8-6-8 6 3-10-8-6h11zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zM27 114l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h9l-8 6 3 10-8-6-8 6 3-10-8-6h11zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zM55 140l3 10h9l-8 6 3 10-8-6-8 6 3-10-8-6h11zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zM27 166l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h9l-8 6 3 10-8-6-8 6 3-10-8-6h11zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zM55 192l3 10h9l-8 6 3 10-8-6-8 6 3-10-8-6h11zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zM27 218l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h9l-8 6 3 10-8-6-8 6 3-10-8-6h11zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10zm55 0l3 10h10l-8 6 3 10-8-6-8 6 3-10-8-6h10z">
                                                        </path>
                                                    </svg>
                                                    <div class="country">United States</div>
                                                </label>
                                                <label class="countryListItem" data-country-native="Việt Nam"
                                                    data-country-english="Vietnam">
                                                    <input type="radio" class="radio" name="country" value="VNM">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480"
                                                        class="languageFlag">
                                                        <path fill="#ec0015" d="M0 0h640v480H0z"></path>
                                                        <path fill="#ff0"
                                                            d="M408 357l-84-63-84 63 31-103-83-64h103l32-102 33 102h103l-83 64 32 103z">
                                                        </path>
                                                    </svg>
                                                    <div class="country">Việt Nam</div>
                                                </label>
                                                <label class="countryListItem" data-country-native="International EUR"
                                                    data-country-english="International EUR">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="640" height="480"
                                                        ...
                                                        <ellipse cx="270.6" cy="227" fill="#FFF" rx=".5" ry=".5">
                                                        </ellipse>
                                                        <path fill="#FFF"
                                                            d="M309.5 215.9l.3-1.5.1-1.1.5-.8 1.4-.6v-2.4h-.7l-.1-.8-1.3-.1-.3.6h-.6l-.1 1h.7l.1.7-.4.5-.3.6-.9.3-2.2 2.1-.1 1-.6.9-.7 1.8-2.5.1-.5 2.3.4 1.8 2.1.9.3-1.2.7-.4.1-1.2.5-.9.7-.9.2-1 1.2-.7 1.4-.3.6-.7zM314.3 217.1v-1.7l-.2-1.6-1.8-.9-1.3 1.2-.2 1.7v1.1l-1.2.2-.2 3.4-.9.4.1 1.2-1.3.4-1.3.4-.2 1.6-.9.6-.5 1.5-.6 3.6s1.1 2.1 1.7 1.1 1.5-1.1 1.5-1.1l.4-.9 3.2.1c.2-1.4 1.8-.9 1.8-.2 0 .6 1.2.1 1.2.1l.8-1.4h1.3l.1-1.5.6-.4v-2c1.9-.6 1.7-2.5 1.7-2.5l.5-.6-.2-.9c-1-.4-.5-1.2.1-1s-.8-1.1-.8-1.1c-.7.6-1.3-.7-1.3-.7l-2.1-.1zM316.2 232.2c-.1 1.5-1.9 2-1.9 2l-1.3-.4-.7-.6-.1-1.7 1.1-.1.2.7 2.7.1zM322.6 224.2c.3 1.1.2-1.7.7-1.6.5.1.1-1.7.1-1.7l-2.1 1.6c1.1.1 1.2 1.2 1.3 1.7zM328.9 217.7c.5 1.1.4 2.7 2.1 4 .6.4-.4 1.2-1 .9-.6-.4-2.3-3.1-2.3-3.1v-1.6c.5-1 1-.6 1.2-.2zM329.7 254.9l-.8.6.4.4.3.6.9-1.4-.8-.2z">
                                                        </path>
                                                ...
                                                <label class="countryListItem" data-country-native="International USD"
                                                    data-country-english="International USD">
                                                    <input type="radio" class="radio" name="country" value="AAB"
                                                        checked="checked">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="640" height="480"
                                                        viewBox="0 0 640 480" class="languageFlag">
                                                        <path fill="#4B92DB" d="M0 0h640v480H0V0z"></path>
                                        ...
                                        <head>
                                            ...
                                            <style>
                                                ...
                                                .favorActive {
                                                    position: relative;
                                                    background-image: url(<?=GP_LOCATION2 ?>/hud/content/favor_medium.png);
                                                    background-color: #f0f0f0;
                                                }

                                                .highlight {
                                                    background-color: yellow;
                                                    /* تغییر رنگ پس زمینه برای تب پیش‌فرض */
                                                }

                                                .contentNavi .tabItem.active {
                                                    background: #ccc;
                                                }
                                                    ...
                                                    <div id="content" class="messages messagesInbox">
                                                        ...
                                                        <div class="contentNavi subNavi">
                                                            <div class="contentNavi tabFavorWrapper">
                                                                <button type="button" class="scrollFrom"
                                                                    disabled="disabled"></button>
                                                                <div style="width:100%" class="scrollingContainer">
                                                                    <div class="content favor favorKeyplayer">
                                                                        <a id="buttonW1" title="" class="tabItem normal"
                                                                            style="font-family: IRANSans;" href="#"
                                                                            data-tab="tab1">پیام‌ها</a>
                                                                    </div>
                                                                    <div class="content favor favorKeyalliance">
                                                                        <a title="" class="tabItem"
                                                                            href="nachrichten.php?t=2"
                                                                            data-tab="tab2">ارسال پیام </a>
                                                                    </div>
                                                                    <div class="content favor favorKeyvillage">
                                                                        <a id="buttonF3" title="" class="tabItem"
                                                                            href="#" data-tab="tab3">پیام های ارسالی</a>
                                                                    </div>

                                                                </div>
                                                                <button type="button" class="scrollTo"
                                                                    disabled="disabled"></button>
                                                            </div>
                                                        </div>
                                                        <div class="tab-content" id="tab1">
                                                            <?php
                                                            include ("goldpay/1.php");
                                                            ?>
                                                            <button class="default-btn"
                                                                onclick="toggleDefaultTab('tab1')"></button>
                                                        </div>
                                                        <div class="tab-content" id="tab2">
                                                            <?php
                                                            include ("goldpay/2.php");
                                                            ?>
                                                        </div>
                                                    </div>
                                                    <button class="default-btn"
                                                        onclick="toggleDefaultTab('tab2')"></button>
                                                </div>
                                                <div class="tab-content" id="tab3">
                                                    <?php
                                                    include ("goldpay/3.php");

                                                    ?>

                                                    <button class="default-btn"
                                                        onclick="toggleDefaultTab('tab3')"></button>
                                ...
                                <div id="notification">تب پیش‌فرض انتخاب شد</div>

                                <script>
                                    let currentTab = localStorage.getItem('defaultTab') || 'tab1';

                                    document.addEventListener('DOMContentLoaded', function () {
                                        const tabs = document.querySelectorAll('.tabItem');
                                        const contents = document.querySelectorAll('.tab-content');
                                        const defaultButton = document.getElementById('tabFavorButton');

                                        function showTab(tabId) {
                                            tabs.forEach(tab => tab.classList.remove('active'));
                                            tabs.forEach(tab => tab.classList.remove('favorActive'));
                                            tabs.forEach(tab => tab.classList.remove('highlight'));
                                            contents.forEach(content => content.classList.remove('active'));

                                            document.querySelector(`[data-tab="${tabId}"]`).classList.add('active');
                                            if (localStorage.getItem('defaultTab') === tabId) {
                                                document.querySelector(`[data-tab="${tabId}"]`).classList.add('favorActive');
                                                document.querySelector(`[data-tab="${tabId}"]`).classList.add('highlight');
                                            }
                                        ...
                                        // Highlight the default button if the current tab is default
                                        if (localStorage.getItem('defaultTab') === currentTab) {
                                            defaultButton.classList.add('active-default');
                                        }
                                    });

                                    function toggleDefaultTab(tabId) {
                                        const defaultButton = document.getElementById('tabFavorButton');
                                        const tabs = document.querySelectorAll('.tabItem');

                                        if (localStorage.getItem('defaultTab') === tabId) {
                                            localStorage.removeItem('defaultTab');
                                            defaultButton.classList.remove('active-default');
                                            tabs.forEach(tab => tab.classList.remove('highlight'));
                                            showNotification(`تب ${tabId} از حالت پیش‌فرض خارج شد.`);
                                        } else {
                                            ...
                                            document.querySelector(`[data-tab="${tabId}"]`).classList.add('favorActive');
                                            document.querySelector(`[data-tab="${tabId}"]`).classList.add('highlight');
                                            showNotification(`تب ${tabId} به عنوان تب پیش‌فرض انتخاب شد.`);
                                        }
                                    }
