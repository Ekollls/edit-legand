<div class="dialogWrapper dialogV2" data-context="paymentWizard" style="z-index: 6010;">
        <div class="dialog paymentShopV4">
            <div class="dialogContainer">
                <div class="dialogContents">
                    <form action="?" method="get" accept-charset="UTF-8">
                        <div class="dialogDragBar"></div>
                        <div class="iconButton buttonFramed green withIcon rectangle info" style="display: none;"></div>
                        <div class="dialogCancelButton iconButton buttonFramed green withIcon rectangle cancel">
  ...
  <path d="M0 17.01L7.01 10 .14 3.13 3.13.14 10 7.01 17.01 0 20 2.99 12.99 10l6.87 6.87-2.99 2.99L10 12.99 2.99 20 0 17.01z"></path>
                        ...
                        <div class="content" id="dialogContent"><div id="paymentWizard" class="buyGold selectPackage">
	<input class="paymentWizardKnowledgeBaseLink hide" type="hidden" name="knowledgeBaseLink" value="">
...
<span class="value ajaxReplaceableGoldAmount">&#x202D;53&#x202C;</span></div>	</div>
	<div class="header">
<div class="contentNavi subNavi">
    <div class="scrollingContainer">
        <div class="content">
            <a href="#" class="tabItem buyGold" title="" data-tabname="buyGold">
                <span>شراء الذهب</span>
            </a>
        </div>
        <div class="content">
            <a href="#" class="tabItem specialOffers" title="" data-tabname="specialOffers">
                <span>المزايا</span>
            </a>
        </div>
        <div class="content">
            <a href="#" class="tabItem vouchers" title="" data-tabname="vouchers">
                <span>قسائم</span>
            </a>
        </div>
        <div class="content">
            <a href="#" class="tabItem pros" title="" data-tabname="pros">
                <span>المميزات</span>
            </a>
        </div>
        <div class="content">
            <a href="#" class="tabItem newTab" title="" data-tabname="newTab">
                <span>تب جدید</span>
            </a>
        </div>
    </div>
...
<div id="tabContent">
    <div id="buyGold" class="tabContent">
        <p>محتوای شراء الذهب</p>
    </div>
